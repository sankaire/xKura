...
1*m);return k}function X(k,m){var w=!1;0>k&&(w=!0,k*=-1);k=""+k;for(m=m?m:1;k.length<m;)k="0"+k;return w?"-"+k:k}function Ea(k){if(!k)return k;k=k.replace(/^\s\s*/,"");for(var m=/\s/,w=k.length;m.test(k.charAt(--w)););return k.slice(0,w+1)}function Aa(k){k.roundRect=function(k,w,s,u,pa,E,y,F){y&&(this.fillStyle=y);F&&(this.strokeStyle=F);"undefined"===typeof pa&&(pa=5);this.lineWidth=E;this.beginPath();this.moveTo(k+pa,w);this.lineTo(k+s-pa,w);this.quadraticCurveTo(k+s,w,k+s,w+pa);this.lineTo(k+s,
w+u-pa);this.quadraticCurveTo(k+s,w+u,k+s-pa,w+u);this.lineTo(k+pa,w+u);this.quadraticCurveTo(k,w+u,k,w+u-pa);this.lineTo(k,w+pa);this.quadraticCurveTo(k,w,k+pa,w);this.closePath();y&&this.fill();F&&0<E&&this.stroke()}}function Oa(k,m){return k-m}function Q(k){var m=((k&16711680)>>16).toString(16),w=((k&65280)>>8).toString(16);k=((k&255)>>0).toString(16);m=2>m.length?"0"+m:m;w=2>w.length?"0"+w:w;k=2>k.length?"0"+k:k;return"#"+m+w+k}function cb(k,m){var w=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=w);s<w;s++)if(s in this&&this[s]===k)return s;return-1}function s(k){return null===k||"undefined"===typeof k}function Ba(k){k.indexOf||(k.indexOf=cb);return k}function db(k){if(J.fSDec)k[Z("`eeDwdouMhrudods")](Z("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){J._fTWm&&J._fTWm(k)})}function Va(k,m,w){w=w||"normal";var s=k+"_"+m+"_"+w,u=Wa[s];if(isNaN(u)){try{k="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
k+"; font-size:"+m+"px; font-weight:"+w+";";if(!va){var pa=document.body;va=document.createElement("span");va.innerHTML="";var E=document.createTextNode("Mpgyi");va.appendChild(E);pa.appendChild(va)}va.style.display="";va.setAttribute("style",k);u=Math.round(va.offsetHeight);va.style.display="none"}catch(y){u=Math.ceil(1.1*m)}u=Math.max(u,m);Wa[s]=u}return u}function O(k,m){var w=[];if(w={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[k||"solid"])for(var s=0;s<w.length;s++)w[s]*=m;else w=[];return w}function U(k,m,w,u,sa){u=u||[];sa=s(sa)?eb?{passive:!1,capture:!1}:!1:sa;u.push([k,m,w,sa]);return k.addEventListener?(k.addEventListener(m,w,sa),w):k.attachEvent?(u=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};w.call(k,m)},k.attachEvent("on"+
m,u),u):!1}function fb(k){if(k._menuButton)k.exportEnabled?(ga(k._menuButton,{backgroundColor:k.toolbar.itemBackgroundColor,color:k.toolbar.fontColor}),Ja(k._menuButton),k._menuButton.title=k._cultureInfo.menuText):ta(k._menuButton);else if(k.exportEnabled&&u){var m=!1;k._menuButton=document.createElement("button");ua(k,k._menuButton,"menu");k._toolBar.appendChild(k._menuButton);U(k._menuButton,"touchstart",function(k){m=!0},k.allDOMEventHandlers);U(k._menuButton,"click",function(){"none"!==k._dropdownMenu.style.display||
k._dropDownCloseTime&&500>=(new Date).getTime()-k._dropDownCloseTime.getTime()||(k._dropdownMenu.style.display="block",k._menuButton.blur(),k._dropdownMenu.focus())},k.allDOMEventHandlers,!0);U(k._menuButton,"mouseover",function(){m||(ga(k._menuButton,{backgroundColor:k.toolbar.itemBackgroundColorOnHover,color:k.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&ga(k._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},k.allDOMEventHandlers,!0);U(k._menuButton,
"mouseout",function(){m||(ga(k._menuButton,{backgroundColor:k.toolbar.itemBackgroundColor,color:k.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&ga(k._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},k.allDOMEventHandlers,!0)}if(k.exportEnabled&&k._dropdownMenu){ga(k._dropdownMenu,{backgroundColor:k.toolbar.itemBackgroundColor,color:k.toolbar.fontColor});for(var w=k._dropdownMenu.childNodes,s=[k._cultureInfo.printText,k._cultureInfo.saveJPGText,k._cultureInfo.savePNGText],
sa=0;sa<w.length;sa++)ga(w[sa],{backgroundColor:k.toolbar.itemBackgroundColor,color:k.toolbar.fontColor}),w[sa].innerHTML=s[sa]}else!k._dropdownMenu&&(k.exportEnabled&&u)&&(m=!1,k._dropdownMenu=document.createElement("div"),k._dropdownMenu.setAttribute("tabindex",-1),w=-1!==k.theme.indexOf("dark")?"black":"#888888",k._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
k.toolbar.itemBackgroundColor+";box-shadow: 2px 2px 10px "+w,k._dropdownMenu.style.display="none",k._toolBar.appendChild(k._dropdownMenu),U(k._dropdownMenu,"blur",function(){ta(k._dropdownMenu);k._dropDownCloseTime=new Date},k.allDOMEventHandlers,!0),w=document.createElement("div"),w.style.cssText="padding: 12px 8px 12px 8px",w.innerHTML=k._cultureInfo.printText,w.style.backgroundColor=k.toolbar.itemBackgroundColor,w.style.color=k.toolbar.fontColor,k._dropdownMenu.appendChild(w),U(w,"touchstart",
function(k){m=!0},k.allDOMEventHandlers),U(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.itemBackgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0),U(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.itemBackgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0),U(w,"click",function(){k.print();ta(k._dropdownMenu)},k.allDOMEventHandlers,!0),w=document.createElement("div"),w.style.cssText="padding: 12px 8px 12px 8px",
w.innerHTML=k._cultureInfo.saveJPGText,w.style.backgroundColor=k.toolbar.itemBackgroundColor,w.style.color=k.toolbar.fontColor,k._dropdownMenu.appendChild(w),U(w,"touchstart",function(k){m=!0},k.allDOMEventHandlers),U(w,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.itemBackgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0),U(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.itemBackgroundColor,this.style.color=k.toolbar.fontColor)},
k.allDOMEventHandlers,!0),U(w,"click",function(){k.exportChart({format:"jpeg",fileName:k.exportFileName});ta(k._dropdownMenu)},k.allDOMEventHandlers,!0),w=document.createElement("div"),w.style.cssText="padding: 12px 8px 12px 8px",w.innerHTML=k._cultureInfo.savePNGText,w.style.backgroundColor=k.toolbar.itemBackgroundColor,w.style.color=k.toolbar.fontColor,k._dropdownMenu.appendChild(w),U(w,"touchstart",function(k){m=!0},k.allDOMEventHandlers),U(w,"mouseover",function(){m||(this.style.backgroundColor=
k.toolbar.itemBackgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0),U(w,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.itemBackgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0),U(w,"click",function(){k.exportChart({format:"png",fileName:k.exportFileName});ta(k._dropdownMenu)},k.allDOMEventHandlers,!0))}function Xa(k,m,w){k*=ka;m*=ka;k=w.getImageData(k,m,2,2).data;m=!0;for(w=0;4>w;w++)if(k[w]!==k[w+4]|k[w]!==k[w+8]|
k[w]!==k[w+12]){m=!1;break}return m?k[0]<<16|k[1]<<8|k[2]:0}function la(k,m,w){return k in m?m[k]:w[k]}function Ka(k,m,w){if(u&&Ya){var s=k.getContext("2d");La=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ka=Pa/La;k.width=m*ka;k.height=w*ka;Pa!==La&&(k.style.width=m+"px",k.style.height=w+"px",s.scale(ka,ka))}else k.width=m,k.height=w}function gb(k){if(!hb){var m=!1,w=!1;"undefined"===typeof oa.Chart.creditHref?
(k.creditHref=Z("iuuqr;..b`ow`rkr/bnl."),k.creditText=Z("B`ow`rKR/bnl")):(m=k.updateOption("creditText"),w=k.updateOption("creditHref"));if(k.creditHref&&k.creditText){k._creditLink||(k._creditLink=document.createElement("a"),k._creditLink.setAttribute("class","canvasjs-chart-credit"),k._creditLink.setAttribute("title","JavaScript Charts"),k._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(k.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
k._creditLink.setAttribute("tabIndex",-1),k._creditLink.setAttribute("target","_blank"));if(0===k.renderCount||m||w)k._creditLink.setAttribute("href",k.creditHref),k._creditLink.innerHTML=k.creditText;k._creditLink&&k.creditHref&&k.creditText?(k._creditLink.parentElement||k._canvasJSContainer.appendChild(k._creditLink),k._creditLink.style.top=k.height-14+"px"):k._creditLink.parentElement&&k._canvasJSContainer.removeChild(k._creditLink)}}}function ra(k,m){Fa&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var w=document.createElement("canvas");w.setAttribute("class","canvasjs-chart-canvas");Ka(w,k,m);u||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(w);return w}function ga(k,m){for(var w in m)k.style[w]=m[w]}function ua(k,m,w){m.getAttribute("state")||(m.style.backgroundColor=k.toolbar.itemBackgroundColor,m.style.color=k.toolbar.fontColor,m.style.border="none",ga(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
w&&(m.setAttribute("state",w),m.setAttribute("type","button"),ga(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",k._cultureInfo[w+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+ib[w].image+"' alt='"+k._cultureInfo[w+"Text"]+"' />")}function Ja(){for(var k=null,m=0;m<arguments.length;m++)k=arguments[m],k.style&&(k.style.display="inline")}function ta(){for(var k=
null,m=0;m<arguments.length;m++)(k=arguments[m])&&k.style&&(k.style.display="none")}function Qa(k,m,w,s,u){if(null===k||"undefined"===typeof k)return"undefined"===typeof w?m:w;k=parseFloat(k.toString())*(0<=k.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(k=Math.min(s,k),"undefined"!==typeof u&&(k=Math.max(u,k)));return!isNaN(k)&&k<=m&&0<=k?k:"undefined"===typeof w?m:w}function V(k,m,w,u,y){this._defaultsKey=k;this._themeOptionsKey=m;this._index=u;this.parent=y;this._eventListeners=[];
...
lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:$,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:S,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Ta,theme2:Za,theme3:Ta},R={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,
hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){J.fSDec=function(k){for(var m="",w=0;w<k.length;w++)m+=String.fromCharCode(k[w]-111);return m};J.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,231,143,178,208,219,216,209,225,216,155,143,187,228,210,216,211,208,143,182,225,208,221,211,212,155,143,187,228,210,
...
225,212,211,216,227,183,225,212,213])]};J._fTWm=function(k){if("undefined"===typeof J.pro.sCH&&!ab){var m=k[J.fSDec(J.str.ct)];m[J.fSDec(J.str.tBl)]=J.fSDec(J.str.tp);m[J.fSDec(J.str.fnt)]=11+J.fSDec(J.str.fntStr);m[J.fSDec(J.str.fSy)]=J.fSDec(J.str.gr);m[J.fSDec(J.str.fTx)](J.fSDec(J.str.ncv),2,k.height-11-2)}}})();var eb=function(){var k=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){k=!0;return!1}});window.addEventListener&&(window.addEventListener("test",
null,m),window.removeEventListener("test",null,m))}catch(w){k=!1}return k}(),Wa={},va=null,jb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},kb=function(k,m,w){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(k/400)))},za=function(){var k=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
...
0>O?(N.push(m),"#"===m||"0"===m?Q++:","===m&&U++):(H.push(m),"#"!==m&&"0"!==m||J++)}R&&(m=Math.floor(k),F=-Math.floor(Math.log(k)/Math.LN10+1),V=0===k?0:0===m?-(Q+F):String(m).length-Q,E/=Math.pow(10,V));0>O&&(O=L);E=(k*E).toFixed(J);m=E.split(".");E=(m[0]+"").split("");k=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(R=F=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===m)if(O++,O===Q){var W=E,E=[];if("0"===m)for(m=Q-J-(W?W.length:0);0<m;)W.unshift("0"),m--;for(;0<W.length;)w=W.pop()+w,R++,0===R%
...
H.shift(),"#"===m||"0"===m?0<k.length&&0!==Number(k.join(""))?(y+=k.shift(),N=!0):"0"===m&&(y+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return X(V,a.length)}));w+=(N?u:"")+y;return s?"-"+w:w},Ma=function(k){var m=0,w=0;k=k||window.event;k.offsetX||0===k.offsetX?
(m=k.offsetX,w=k.offsetY):k.layerX||0==k.layerX?(m=k.layerX,w=k.layerY):(m=k.pageX-k.target.offsetLeft,w=k.pageY-k.target.offsetTop);return{x:m,y:w}},Ya=!0,Pa=window.devicePixelRatio||1,La=1,ka=Ya?Pa/La:1,ca=function(k,m,w,s,u,y,E,F,O,N,R,Q,H){"undefined"===typeof H&&(H=1);E=E||0;F=F||"black";var J=15<s-m&&15<u-w?8:0.35*Math.min(s-m,u-w);k.beginPath();k.moveTo(m,w);k.save();k.fillStyle=y;k.globalAlpha=H;k.fillRect(m,w,s-m,u-w);k.globalAlpha=1;0<E&&(H=0===E%2?0:0.5,k.beginPath(),k.lineWidth=E,k.strokeStyle=
F,k.moveTo(m,w),k.rect(m-H,w-H,s-m+2*H,u-w+2*H),k.stroke());k.restore();!0===O&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+J,w+J),k.lineTo(s-J,w+J),k.lineTo(s,w),k.closePath(),E=k.createLinearGradient((s+m)/2,w+J,(s+m)/2,w),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=E,k.fill(),k.restore());!0===N&&(k.save(),k.beginPath(),k.moveTo(m,u),k.lineTo(m+J,u-J),k.lineTo(s-J,u-J),k.lineTo(s,u),k.closePath(),E=k.createLinearGradient((s+m)/2,u-J,(s+m)/2,u),E.addColorStop(0,
y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=E,k.fill(),k.restore());!0===R&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+J,w+J),k.lineTo(m+J,u-J),k.lineTo(m,u),k.closePath(),E=k.createLinearGradient(m+J,(u+w)/2,m,(u+w)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=E,k.fill(),k.restore());!0===Q&&(k.save(),k.beginPath(),k.moveTo(s,w),k.lineTo(s-J,w+J),k.lineTo(s-J,u-J),k.lineTo(s,u),E=k.createLinearGradient(s-J,(u+w)/2,s,(u+w)/2),E.addColorStop(0,
y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=E,E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=E,k.fill(),k.closePath(),k.restore())},Z=function(k){for(var m="",s=0;s<k.length;s++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(s));return m},ab=window&&window[Z("mnb`uhno")]&&window[Z("mnb`uhno")].href&&window[Z("mnb`uhno")].href.indexOf&&(-1!==window[Z("mnb`uhno")].href.indexOf(Z("b`ow`rkr/bnl"))||-1!==window[Z("mnb`uhno")].href.indexOf(Z("gdonqhy/bnl"))||
-1!==window[Z("mnb`uhno")].href.indexOf(Z("gheemd"))),hb=ab&&-1===window[Z("mnb`uhno")].href.indexOf(Z("gheemd")),ib={reset:{image:"data:image/png;base64,"},
...
m=s):m=void 0,k[m]=this.options};V.prototype.remove=function(k){k="undefined"===typeof k?!0:k;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ba(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];k&&(this.stockChart||this.chart||this).render()};V.prototype.updateOption=function(k){!oa[this._defaultsKey]&&(Fa&&window.console)&&console.log("defaults not set");var m=oa[this._defaultsKey],u={},y=this[k],F=this._themeOptionsKey,
...
null};ia.prototype.measureText=function(){this._lineHeight=Va(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ia.prototype._getLineWithWidth=function(k,m,s){k=String(k);if(!k)return{text:"",width:0};var u=s=0,y=k.length-1,F=Infinity;for(this.ctx.font=this._getFontString();u<=y;){var F=Math.floor((u+y)/2),E=k.substr(0,F+1);s=this.ctx.measureText(E).width;
if(s<m)u=F+1;else if(s>m)y=F-1;else break}s>m&&1<E.length&&(E=E.substr(0,E.length-1),s=this.ctx.measureText(E).width);m=!0;if(E.length===k.length||" "===k[E.length])m=!1;m&&(k=E.split(" "),1<k.length&&k.pop(),E=k.join(" "),s=this.ctx.measureText(E).width);return{text:E,width:s}};ia.prototype._wrapText=function(){var k=new String(Ea(String(this.text))),m=[],s=this.ctx.font,u=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=u=0;else for(;0<k.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),E=this._getLineWithWidth(k,this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;m.push(E);var J=y,y=Math.max(y,E.width),u=u+E.height,k=Ea(k.slice(E.text.length,k.length));F&&u>F&&(E=m.pop(),u-=E.height,y=J)}this._wrappedText={lines:m,width:y,height:u};this.width=y+(this.leftPadding+this.rightPadding);this.height=u+(this.topPadding+this.bottomPadding);this.ctx.font=s};ia.prototype._getFontString=function(){var k;k=""+(this.fontStyle?this.fontStyle+" ":
"");k+=this.fontWeight?this.fontWeight+" ":"";k+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!u&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return k+=m};na(Ra,V);na(xa,V);xa.prototype.setLayout=function(){if(this.text){var k=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=k.layoutManager.getFreeSpace(),u=m.x1,y=m.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,O,H;"top"===this.verticalAlign||
...
2+1;var A=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[v].x>a[f].x&&0<A||a[v].x<a[f].x&&0>A?{x:a[v].x+A/3,y:a[v].y+b/3}:{x:a[v].x,y:a[v].y+b/9};v=e;f=0===v?0:v-1;l=v===a.length-1?v:v+1;b=Math.abs((a[l].x-a[f].x)/(0===a[v].x-a[f].x?0.01:a[v].x-a[f].x))*(d-1)/2+1;A=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[v].x>a[f].x&&0<A||a[v].x<a[f].x&&0>A?{x:a[v].x-A/3,y:a[v].y-b/3}:{x:a[v].x,y:a[v].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,l,v,A,h){var n=0;h?(l.color=f,v.color=f):
h=1;n=A?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);A?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(v.thickness)%2?0.5:0;a.save();a.globalAlpha=h;a.strokeStyle=v.color||f;a.lineWidth=v.thickness||2;a.setLineDash&&a.setLineDash(O(v.dashType,v.thickness));a.beginPath();A&&0<v.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<v.thickness&&(a.moveTo(Math.round((d+
...
new Ha(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&u;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Ra(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)ga(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+
...
function(a){d=!0},this.allDOMEventHandlers);U(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,ua(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);U(this._zoomButton,"mouseover",function(){d?d=!1:(ga(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._zoomButton.childNodes[0],
{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);U(this._zoomButton,"mouseout",function(){d||(ga(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?(ga(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+
...
U(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},a.toolTip);a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,ua(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=
...
"reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),U(this._resetButton,"mouseover",function(){d||(ga(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},
this.allDOMEventHandlers),U(this._resetButton,"mouseout",function(){d||(ga(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&ga(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?
(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),Ja(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;fb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?ua(a,a._zoomButton,"zoom"):ua(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&ua(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=
...
this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor):(ta(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));db(this);this._processData();this.options.title&&(this.title=new xa(this,this.options.title),
this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Ga(this,this.options.subtitles[d],d),this.subtitles.push(c),c.dockInsidePlotArea?a.push(c):c.setLayout();this.legend=new F(this,this.options.legend);for(d=0;d<this.data.length;d++)(this.data[d].showInLegend||"pie"===this.data[d].type||"doughnut"===this.data[d].type||"funnel"===this.data[d].type||"pyramid"===this.data[d].type)&&this.legend.dataSeries.push(this.data[d]);
...
this.plotInfo.axisPlacement)E.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ra(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}gb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=3;u&&this._breaksCanvas&&(this._preRenderCtx.drawImage(this.canvas,
...
"candlestick"===v.type?A=this.renderCandlestick(v):"ohlc"===v.type?A=this.renderCandlestick(v):"rangeColumn"===v.type?A=this.renderRangeColumn(v):"error"===v.type?A=this.renderError(v):"rangeBar"===v.type?A=this.renderRangeBar(v):"rangeArea"===v.type?A=this.renderRangeArea(v):"rangeSplineArea"===v.type?A=this.renderRangeSplineArea(v):"waterfall"===v.type?A=this.renderWaterfall(v):"boxAndWhisker"===v.type&&(A=this.renderBoxAndWhisker(v));for(var h=0;h<v.dataSeriesIndexes.length;h++)this._dataInRenderedOrder.push(this.data[v.dataSeriesIndexes[h]]);
this.animatedRender&&(v.targetCanvasCtx.miterLimit=e,A&&c.push(A))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&(e=ra(this.width,this.height).getContext("2d"),c.push(this.renderIndexLabels(e)));var n=this;if(0<c.length)n.disableToolTip=!0,n._animator.animate(200,
...
n.plotInfo.plotTypes[a],d=0;d<e.plotUnits.length;d++)e.plotUnits[d].targetCanvas=null;b=null;n.disableToolTip=!1;n.dispatchEvent("dataAnimationEnd",{chart:n})});else{if(n._breaksCanvas)if(u)n.plotArea.ctx.drawImage(n._breaksCanvas,0,0,this.width,this.height);else for(h=0;h<n._axes.length;h++)n._axes[h].createMask();0<n._indexLabels.length&&n.renderIndexLabels();n.dispatchEvent("dataAnimationIterationEnd",{chart:n});n.dispatchEvent("dataAnimationEnd",{chart:n})}this.attachPlotAreaEventHandlers();this.zoomEnabled||
(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||ta(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();this.renderCount++;Fa&&(n=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(Ka(a,n.width,n.height),a.getContext("2d").drawImage(n._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&(delete this._breaksCanvas,delete this._breaksCanvasCtx);for(h=0;h<this._axes.length;h++)this._axes[h].maskCanvas&&(delete this._axes[h].maskCanvas,
delete this._axes[h].maskCtx)};m.prototype.render=function(a){a&&(this.options=a);this._initialize();this.setLayout();this.renderElements();this._preRenderCanvas=null};m.prototype.attachPlotAreaEventHandlers=function(){this.attachEvent({context:this,chart:this,mousedown:this._plotAreaMouseDown,mouseup:this._plotAreaMouseUp,mousemove:this._plotAreaMouseMove,cursor:this.panEnabled?"move":"default",capture:!0,bounds:this.plotArea})};m.prototype.categoriseDataSeries=function(){for(var a="",d=0;d<this.data.length;d++)if(a=
...
"waterfall"===b.type&&this._processSpecificPlotUnit(b)}this.calculateAutoBreaks()};m.prototype._processMultiseriesPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var v=this.data[a.dataSeriesIndexes[l]],A=0,h=!1,n=!1,p;if("normal"===v.axisPlacement||"xySwapped"===v.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&
...
(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==v.dataPoints[A-1].y&&(a.axisY.logarithmic?(r=e/v.dataPoints[A-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-v.dataPoints[A-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!h)null!==e&&(p=b);else{if(!h&&(h=!0,0<A)){A-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;v.dataPoints[A].label&&(a.axisX.labels[b]=v.dataPoints[A].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===
b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}v.axisX.valueType=v.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],v=[],A=Infinity,h=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,k;if("normal"===p.axisPlacement||
...
x)}else x=b-p.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/p.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-p.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<m&&!g)null!==p.dataPoints[q].y&&(k=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>t&&!r)r=!0;else if(b>t&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=
b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&k<b&&(c.viewPortMin=k):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,A=Math.min(e,A)):v[b]?v[b]+=e:(v[b]=e,h=Math.max(e,h)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,
v)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=v));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,A)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,A)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in v)v.hasOwnProperty(q)&&!isNaN(q)&&(a=v[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,h)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=
a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,h))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,v=!1,A=[],h=0;h<a.dataSeriesIndexes.length;h++){var n=this.data[a.dataSeriesIndexes[h]],p=0,q=!1,g=!1,r;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var k=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&
...
(a.axisY.logarithmic?0<e&&(t=e/n.dataPoints[p-1].y,1>t&&(t=1/t),d.minDiff>t&&1!==t&&(d.minDiff=t)):(t=e-n.dataPoints[p-1].y,0>t&&(t*=-1),d.minDiff>t&&0!==t&&(d.minDiff=t)))}if(b<k&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:
...
v?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,99),d.min=s(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99)):!l&&v&&(d.max=s(d.viewPortMax)?-1:Math.max(d.viewPortMax,-1),d.min=s(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99));d.viewPortMin=d.min;d.viewPortMax=d.max;a.dataPointYSums=A}};m.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f,l,v=!1,A=0;A<a.dataSeriesIndexes.length;A++){var h=this.data[a.dataSeriesIndexes[A]],
n=0,p=!1,q=!1,g,r,k;if("normal"===h.axisPlacement||"xySwapped"===h.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(h.dataPoints[n].x&&h.dataPoints[n].x.getTime||"dateTime"===h.xValueType)v=!0;for(n=0;n<h.dataPoints.length;n++){"undefined"===typeof h.dataPoints[n].x&&(h.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));h.dataPoints[n].x.getTime?(v=!0,b=h.dataPoints[n].x.getTime()):b=h.dataPoints[n].x;if((e=h.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var x=
0;x<e.length;x++)null===e.k&&(r=!1);r&&(p||(k=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/h.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-h.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&h.dataPoints[n-1].y&&null!==h.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/h.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-h.dataPoints[n-1].y[0],
0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=k;continue}if(b>t&&!q)q=!0;else if(b>t&&q)continue;h.dataPoints[n].label&&(a.axisX.labels[b]=h.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}h.axisX.valueType=
h.xValueType=v?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var v=this.data[a.dataSeriesIndexes[l]],A=0,h=!1,n=!1,p=b=0;if("normal"===v.axisPlacement||"xySwapped"===v.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?
...
(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=v.dataPointEOs[A].cumulativeSum-v.dataPointEOs[A-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||h){if(!h&&(h=!0,0<A)){A-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;v.dataPoints[A].label&&(a.axisX.labels[b]=v.dataPoints[A].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<A&&(v.dataPointEOs[A-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=v.dataPointEOs[A-1].cumulativeSum),v.dataPointEOs[A-
...
c,endValue:b/c};c=0.2*Math.min(c-b+a,b-a);0>=c&&(c=0.25*Math.min(b-a,Math.abs(a)));return{startValue:a+c,endValue:b-c}}function d(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){var b=a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks,c=a.axisY.scaleBreaks&&a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks;if(b||c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,h=f.min,l=f.max,n=d.min,p=d.max,f=f._dataRanges,
d=d._dataRanges,q,v=0,A=0;A<a.dataSeriesIndexes.length;A++){var k=e.data[a.dataSeriesIndexes[A]];if(!(4>k.dataPoints.length))for(v=0;v<k.dataPoints.length;v++)if(b&&(q=(l+1-h)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=k.dataPoints[v].x.getTime?k.dataPoints[v].x.getTime():k.dataPoints[v].x,q=Math.floor((g-h)/q),g<f[q].min&&(f[q].min=g),g>f[q].max&&(f[q].max=g)),c){var m=(p+1-n)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((g="waterfall"===
a.type?k.dataPointEOs[v].cumulativeSum:k.dataPoints[v].y)&&g.length)for(var u=0;u<g.length;u++)q=Math.floor((g[u]-n)/m),g[u]<d[q].min&&(d[q].min=g[u]),g[u]>d[q].max&&(d[q].max=g[u]);else s(g)||(q=Math.floor((g-n)/m),g<d[q].min&&(d[q].min=g),g>d[q].max&&(d[q].max=g))}}}}function c(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=b.min,d=b.max,f=b._dataRanges,
g,h=0,l=0;l<a.dataSeriesIndexes.length;l++){var n=e.data[a.dataSeriesIndexes[l]];if(!(4>n.dataPoints.length))for(h=0;h<n.dataPoints.length;h++)g=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=n.dataPoints[h].x.getTime?n.dataPoints[h].x.getTime():n.dataPoints[h].x,g=Math.floor((b-c)/g),b<f[g].min&&(f[g].min=b),b>f[g].max&&(f[g].max=b)}}for(var b,e=this,f=!1,l=0;l<this._axes.length;l++)if(this._axes[l].scaleBreaks&&this._axes[l].scaleBreaks.autoCalculate&&1<=this._axes[l].scaleBreaks.maxNumberOfAutoBreaks){f=
...
n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=h;for(v in q)if(q.hasOwnProperty(v)&&!isNaN(v)&&(p=q[v],!s(p))){var g=Math.floor((p-A)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;n=h;for(v in q)q.hasOwnProperty(v)&&!isNaN(v)&&(p=-1*q[v],s(p)||(g=Math.floor((p-A)/b),p<n[g].min&&
(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(v=0;v<h.length-1;v++)if(n=h[v].max,isFinite(n))for(;v<h.length-1;)if(A=h[v+1].min,isFinite(A)){p=A-n;p>b&&f.push({diff:p,start:n,end:A});break}else v++;if(this._axes[l].scaleBreaks.customBreaks)for(v=0;v<this._axes[l].scaleBreaks.customBreaks.length;v++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[v].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[v].endValue||
...
(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(u)b=Xa(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=kb;m.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};
m.prototype.clearCanvas=jb;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=Ma(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;case "touchend":case "MSPointerUp":var f=this._lastTouchData&&this._lastTouchData.time?
...
(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ja(this._zoomButton,this._resetButton),ua(this,this._zoomButton,"pan"),ua(this,this._resetButton,"reset")))}}this.isDrag=!1;if("none"!==this.plotInfo.axisPlacement){this.resetOverlayedCanvas();if(this.axisX&&0<this.axisX.length)for(l=0;l<this.axisX.length;l++)this.axisX[l].crosshair&&
...
this.zoomType).isValid&&(this.resetOverlayedCanvas(),this.overlaidCanvasCtx.fillStyle="#99B2B5");this.overlaidCanvasCtx.globalAlpha=0.7;this.overlaidCanvasCtx.fillRect(b,v,A,h);this.overlaidCanvasCtx.globalAlpha=c}}else if(this.toolTip.mouseMoveHandler(a,d),"none"!==this.plotInfo.axisPlacement){if(this.axisX&&0<this.axisX.length)for(e=0;e<this.axisX.length;e++)this.axisX[e].crosshair&&this.axisX[e].crosshair.enabled&&this.axisX[e].renderCrosshair(a,d);if(this.axisX2&&0<this.axisX2.length)for(e=0;e<
...
l=0<=this.zoomType.indexOf("y"),v=!1,A=[],h=[],n=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&h.push(this._axes[p]);for(l=0;l<h.length;l++){var p=h[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var r=g,g=q,q=r;if(p.scaleBreaks)for(r=0;!f&&r<p.scaleBreaks._appliedBreaks.length;r++)f=p.scaleBreaks._appliedBreaks[r].startValue<=q&&p.scaleBreaks._appliedBreaks[r].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(r=
...
new Ca(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,v=0,A=b=0,h=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=la("indexLabelFontColor",n.dataPoint,n.dataSeries),r=la("indexLabelFontSize",n.dataPoint,n.dataSeries),v=la("indexLabelFontFamily",n.dataPoint,n.dataSeries),A=la("indexLabelFontStyle",n.dataPoint,n.dataSeries),h=la("indexLabelFontWeight",n.dataPoint,
n.dataSeries),k=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=la("indexLabelMaxWidth",n.dataPoint,n.dataSeries);g=la("indexLabelWrap",n.dataPoint,n.dataSeries);var m=la("indexLabelLineDashType",n.dataPoint,n.dataSeries),t=la("indexLabelLineColor",n.dataPoint,n.dataSeries),x=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?
...
f=n.dataSeries.axisY,y=!1,k=new ia(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===B?0:-90,text:D,padding:0,backgroundColor:k,textAlign:z,fontSize:r,fontFamily:v,fontWeight:h,fontColor:l,fontStyle:A,textBaseline:"middle"});k.measureText();n.dataSeries.indexLabelMaxWidth=k.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||
...
e.viewportMaximum)continue;l=v=2;"horizontal"===B?(A=k.width,h=k.height):(h=k.width,A=k.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))C="auto",v=4;else if(0<=p.indexOf("stacked"))"auto"===C&&(C="inside");else if("bubble"===p||"scatter"===p)C="inside";q=n.point.x-("horizontal"===B?A/2:A/2-r/2);"inside"!==C?(e=c.y1,f=c.y2,0<w?(g=n.point.y+("horizontal"===B?r/2:0)-h-v-b,g<e&&(g="auto"===C?Math.max(n.point.y,e)+r/2+v:e+r/2+v,y=g+h>n.point.y)):(g=n.point.y+
r/2+v+b,g>f-h&&(g="auto"===C?Math.min(n.point.y,f)+r/2-h-v:f+r/2-h,y=g<n.point.y))):(e=Math.max(n.bounds.y1,c.y1),f=Math.min(n.bounds.y2,c.y2-h+r/2),b=0<=p.indexOf("range")||"error"===p?0<w?Math.max(n.bounds.y1,c.y1)+r/2+v:Math.min(n.bounds.y2,c.y2)+r/2-h+v:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-h/2+r/2+("horizontal"===B?v:0),0<w?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-h-v,c.y1+v))):(g=Math.min(n.point.y,b),g>f-h-v&&("bubble"===p||"scatter"===
p)&&(g=Math.min(n.point.y+v,c.y2-h-v))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(C="auto",l=4):0<=p.indexOf("stacked")?"auto"===C&&(C="inside"):"bubble"===p&&(C="inside"),g=n.point.y+r/2-h/2+v,"inside"!==C?(e=c.x1,f=c.x2,0>w?(q=n.point.x-("horizontal"===B?A:A-r/2)-l-b,q<e&&(q="auto"===C?Math.max(n.point.x,e)+l:e+l,y=q+A>n.point.x)):(q=n.point.x+("horizontal"===B?0:r/2)+l+b,q>f-A-l-b&&(q="auto"===C?Math.min(n.point.x,f)-("horizontal"===B?A:A/2)-l:f-
A-l,y=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>w?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-A/2-l+("horizontal"===B?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===B?0:r/2),q=0>w?Math.max(n.point.x,b)-("horizontal"===B?A/2:0):Math.min(n.point.x,b)-A/2,q=Math.max(q,e));"vertical"===B&&(g+=h-r/2);k.x=q;k.y=g;k.render(!0);x&&("inside"!==C&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&
n.point.x>c.x1&&n.point.x<c.x2||!y)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&n.point.y<c.y2||!y))&&(d.lineWidth=x,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(O(m,x)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:A+l)+("vertical"===B?-r/2:0),g+("vertical"===B?-h/2:h/2-r/2)-v):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+A/2-("horizontal"===B?0:r/2),g+("vertical"===B?
(g-h<n.point.y?0:-h)+v:(g-r/2<n.point.y?h:0)-r/2)):d.lineTo(q+A/2-("horizontal"===B?0:r/2),g+("vertical"===B?g-h<n.point.y?0:-h:(g-r/2<n.point.y?h:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],k=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(k)?u?"transparent":null:k;
return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,v=0;v<a.dataSeriesIndexes.length;v++){var A=a.dataSeriesIndexes[v],h=this.data[A];c.lineWidth=h.lineThickness;var n=h.dataPoints,p="solid";if(c.setLineDash){var q=O(h.nullDataLineDashType,h.lineThickness),p=h.lineDashType,
g=O(p,h.lineThickness);c.setLineDash(g)}var r=h.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=Q(r);b.strokeStyle=r;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var r=h._colorSet,k=r=h.lineColor=h.options.lineColor?h.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var B=!1,t=0;t<n.length;t++)if(x=n[t].x.getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||
!B)))if("number"!==typeof n[t].y)0<t&&!(h.connectNullData||B||m)&&(c.stroke(),u&&b.stroke()),B=!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var D=h.dataPointIds[t];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:x,y1:s};m||B?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||p===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=h.nullDataLineDashType,
c.setLineDash(q)),c.lineTo(x,s),u&&b.lineTo(x,s)):(c.beginPath(),c.moveTo(x,s),u&&(b.beginPath(),b.moveTo(x,s))),B=m=!1):(c.lineTo(x,s),u&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),u&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(k!==(n[t].lineColor||r)||p!==(n[t].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),k=n[t].lineColor||r,c.strokeStyle=k,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,h.lineThickness))):
(p=h.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<h.markerSize){var z=h.getMarkerProperties(t,x,s,c);f.push(z);D=Q(D);u&&f.push({x:x,y:s,ctx:b,type:z.type,size:z.size,color:D,borderColor:D,borderThickness:z.borderThickness})}(n[t].indexLabel||h.indexLabel||n[t].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:h,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();u&&b.stroke()}}W.drawMarkers(f);u&&
...
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,v=0;v<a.dataSeriesIndexes.length;v++){var A=a.dataSeriesIndexes[v],h=this.data[A];c.lineWidth=h.lineThickness;var n=h.dataPoints,p="solid";if(c.setLineDash){var q=O(h.nullDataLineDashType,
h.lineThickness),p=h.lineDashType,g=O(p,h.lineThickness);c.setLineDash(g)}var r=h.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=Q(r);b.strokeStyle=r;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var r=h._colorSet,k=r=h.lineColor=h.options.lineColor?h.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var B=!1,t=0;t<n.length;t++)if(x=n[t].getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&
(!h.connectNullData||!B)))if("number"!==typeof n[t].y)0<t&&!(h.connectNullData||B||m)&&(c.stroke(),u&&b.stroke()),B=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var z=h.dataPointIds[t];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:x,y1:s};m||B?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||p===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,
l.y),p=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,D),c.lineTo(x,s),u&&(b.lineTo(x,D),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),u&&(b.beginPath(),b.moveTo(x,s))),B=m=!1):(c.lineTo(x,D),u&&b.lineTo(x,D),c.lineTo(x,s),u&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),u&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(k!==(n[t].lineColor||r)||p!==(n[t].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),k=n[t].lineColor||r,c.strokeStyle=
k,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,h.lineThickness))):(p=h.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<h.markerSize)D=h.getMarkerProperties(t,x,s,c),f.push(D),z=Q(z),u&&f.push({x:x,y:s,ctx:b,type:D.type,size:D.size,color:z,borderColor:z,borderThickness:D.borderThickness});(n[t].indexLabel||h.indexLabel||n[t].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:h,point:{x:x,y:s},direction:0>
n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();u&&b.stroke()}}W.drawMarkers(f);u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());
c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=w(a,2);if(0<a.length){b.beginPath();u&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);u&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],v=0;v<a.dataSeriesIndexes.length;v++){var A=a.dataSeriesIndexes[v],h=this.data[A];b.lineWidth=h.lineThickness;var n=h.dataPoints,p="solid";if(b.setLineDash){var q=O(h.nullDataLineDashType,h.lineThickness),p=h.lineDashType,g=O(p,h.lineThickness);b.setLineDash(g)}var r=h.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:A};r=Q(r);e.strokeStyle=r;e.lineWidth=
0<h.lineThickness?Math.max(h.lineThickness,4):0;var r=h._colorSet,k=r=h.lineColor=h.options.lineColor?h.options.lineColor:r[0];b.strokeStyle=r;var m=0,t,x,s=[];b.beginPath();if(0<n.length)for(x=!1,m=0;m<n.length;m++)if(t=n[m].getTime?n[m].x.getTime():n[m].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!x)))if("number"!==typeof n[m].y)0<m&&!x&&(h.connectNullData?b.setLineDash&&(0<s.length&&(h.options.nullDataLineDashType||!n[m-1].lineDashType))&&(s[s.length-
1].newLineDashArray=q,p=h.nullDataLineDashType):(d(s),s=[])),x=!0;else{t=a.axisX.convertValueToPixel(t);x=a.axisY.convertValueToPixel(n[m].y);var B=h.dataPointIds[m];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:m,x1:t,y1:x};s[s.length]={x:t,y:x};m<n.length-1&&(k!==(n[m].lineColor||r)||p!==(n[m].lineDashType||h.lineDashType))&&(k=n[m].lineColor||r,s[s.length-1].newStrokeStyle=k,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,s[s.length-1].newLineDashArray=
O(p,h.lineThickness)):(p=h.lineDashType,s[s.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<h.markerSize){var D=h.getMarkerProperties(m,t,x,b);l.push(D);B=Q(B);u&&l.push({x:t,y:x,ctx:e,type:D.type,size:D.size,color:B,borderColor:B,borderThickness:D.borderThickness})}(n[m].indexLabel||h.indexLabel||n[m].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:h,point:{x:t,y:x},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}W.drawMarkers(l);
...
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,v,A,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
n<f)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>n&&(p=n);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length)for(var k=5<p&&g.bevelEnabled?!0:!1,f=
0;f<r.length;f++)if(r[f].getTime?A=r[f].x.getTime():A=r[f].x,!(A<a.axisX.dataInfo.viewPortMin||A>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(A);v=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;0<=r[f].y?t=h:(t=v,v=h);v>t&&(b=v,v=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];
ca(c,l,v,m,t,b,0,null,k&&0<=r[f].y,0>r[f].y&&k,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:v,x2:m,y2:t};b=Q(b);u&&ca(this._eventManager.ghostCtx,l,v,m,t,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?v:t},direction:0>r[f].y===
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:h<a.axisY.bounds.y1?a.axisY.bounds.y1:h>a.axisY.bounds.y2?a.axisY.bounds.y2:h}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],A=[],h=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=
...
a.dataSeriesIndexes[r],m=this.data[k],t=m.dataPoints;if(0<t.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<t.length;h++)if(b=t[h].x.getTime?t[h].x.getTime():t[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[h].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[h].y)v[b]=t[h].y+(v[b]?v[b]:
0),0<v[b]&&(p=a.axisY.convertValueToPixel(v[b]),D="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=t[h].y+(A[b]?A[b]:0),D=a.axisY.convertValueToPixel(A[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(t[h].y),0<=t[h].y){var z="undefined"!==typeof f[b]?f[b]:0;p-=z;D=q-z;f[b]=z+(D-p)}else z=l[b]?l[b]:0,D=p+z,p=q+z,l[b]=z+(D-p);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];
ca(c,s,p,B,D,b,0,null,x&&0<=t[h].y,0>t[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:s,y1:p,x2:B,y2:D};b=Q(b);u&&ca(this._eventManager.ghostCtx,s,p,B,D,b,0,null,!1,!1,!1,!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[h],dataSeries:m,point:{x:n,y:0<=t[h].y?p:D},direction:0>t[h].y===a.axisY.reversed?
1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:B,y2:Math.max(p,D)},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],A=[],h=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&
h>n&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<h)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>n&&(g=n);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var k=
a.dataSeriesIndexes[r],m=this.data[k],t=m.dataPoints;if(0<t.length)for(var s=5<g&&m.bevelEnabled?!0:!1,h=0;h<t.length;h++)if(b=t[h].x.getTime?t[h].x.getTime():t[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[h].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[h].y/a.dataPointYSums[b]):0;var C=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=C+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0<t[h].y){v[b]=p+("undefined"!==typeof v[b]?v[b]:0);if(0>=v[b])continue;p=a.axisY.convertValueToPixel(v[b]);D=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=p+("undefined"!==typeof A[b]?A[b]:0),D=a.axisY.convertValueToPixel(A[b]),p=l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(p),0<=t[h].y){var z="undefined"!==typeof f[b]?f[b]:0;p-=z;D=q-z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=z+(D-p)}else z="undefined"!==
typeof l[b]?l[b]:0,D=p+z,p=q+z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=z+(D-p);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];ca(c,C,p,B,D,b,0,null,s&&0<=t[h].y,0>t[h].y&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:C,y1:p,x2:B,y2:D};b=Q(b);u&&ca(this._eventManager.ghostCtx,C,p,B,D,b,0,null,!1,!1,!1,!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[h],dataSeries:m,point:{x:n,y:0<=t[h].y?p:D},direction:0>t[h].y===a.axisY.reversed?1:-1,bounds:{x1:C,y1:Math.min(p,D),x2:B,y2:Math.max(p,D)},color:b})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
l=a.axisY.convertValueToPixel(r[f].y);v=a.axisX.reversed?v+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:v-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?v-p<<0:v+p<<0,t;0<=r[f].y?t=h:(t=l,l=h);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ca(c,t,v,l,m,b,0,null,k,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:t,y1:v,x2:l,y2:m};b=
Q(b);u&&ca(this._eventManager.ghostCtx,t,v,l,m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:t,y:v+(m-v)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(t,l),y1:v,x2:Math.max(t,l),y2:m},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
h}}};m.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],v=[],A=[],h=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<
0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>p&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<h)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<
h&&(g=h);g>p&&(g=p);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var k=a.dataSeriesIndexes[r],m=this.data[k],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<t.length;h++)if(b=t[h].x.getTime?t[h].x.getTime():
t[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[h].y){p=a.axisX.convertValueToPixel(b);var C=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,B=C+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[h].y)v[b]=t[h].y+(v[b]?v[b]:0),0<v[b]&&(D=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(v[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=t[h].y+(A[b]?A[b]:0),n=l[b]?
l[b]:q,l[b]=D=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(t[h].y),0<=t[h].y){var z=f[b]?f[b]:0;D=q+z;n+=z;f[b]=z+(n-D)}else z=l[b]?l[b]:0,D=n-z,n=q-z,l[b]=z+(n-D);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];ca(c,D,C,n,B,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:D,y1:C,x2:n,y2:B};b=Q(b);u&&ca(this._eventManager.ghostCtx,D,C,n,B,b,0,null,!1,!1,!1,
!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[h],dataSeries:m,point:{x:0<=t[h].y?n:D,y:p},direction:0>t[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,n),y1:C,x2:Math.max(D,n),y2:B},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>p&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<h)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>p&&(g=p);c.save();u&&this._eventManager.ghostCtx.save();
c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var k=a.dataSeriesIndexes[r],m=this.data[k],t=m.dataPoints;if(0<t.length){var s=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<t.length;h++)if(b=t[h].x.getTime?t[h].x.getTime():t[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&
"number"===typeof t[h].y){p=a.axisX.convertValueToPixel(b);var C;C=0!==a.dataPointYSums[b]?100*(t[h].y/a.dataPointYSums[b]):0;var B=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=B+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[h].y){v[b]=C+(v[b]?v[b]:0);if(0>=v[b])continue;C=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(v[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[h].y)A[b]=C+(A[b]?A[b]:0),n=l[b]?l[b]:
q,l[b]=C=a.axisY.convertValueToPixel(A[b]);else if(n=a.axisY.convertValueToPixel(C),0<=t[h].y){var z=f[b]?f[b]:0;C=q+z;n+=z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=z+(n-C)}else z=l[b]?l[b]:0,C=n-z,n=q-z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-C)&&(C=e.x1),l[b]=z+(n-C);b=t[h].color?t[h].color:m._colorSet[h%m._colorSet.length];ca(c,C,B,n,D,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,
dataPointIndex:h,x1:C,y1:B,x2:n,y2:D};b=Q(b);u&&ca(this._eventManager.ghostCtx,C,B,n,D,b,0,null,!1,!1,!1,!1);(t[h].indexLabel||m.indexLabel||t[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[h],dataSeries:m,point:{x:0<=t[h].y?n:C,y:p},direction:0>t[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(C,n),y1:B,x2:Math.max(C,n),y2:D},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?B=C:0>a.axisY.viewportMaximum?B=v.y1:0<a.axisY.viewportMinimum&&(B=C),f.lineTo(m,B),f.lineTo(D.x,B),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(l.lineTo(m,B),l.lineTo(D.x,B),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}
var e=a.targetCanvasCtx||this.plotArea.ctx,f=u?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,v=a.axisY.lineCoordinates,A=[],h=this.plotArea,n;f.save();u&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();u&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};
A=Q(A);l.fillStyle=A;A=[];d=!0;var k=0,m,t,s,C=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),B,D=null;if(0<r.length){var z=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||z,y=w;f.fillStyle=z;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var K=O(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=O(c,g.lineThickness);f.setLineDash(aa)}for(var ja=!0;k<r.length;k++)if(s=r[k].x.getTime?r[k].x.getTime():r[k].x,!(s<
a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof r[k].y)g.connectNullData||(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(r[k].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,D=n,c=g.nullDataLineDashType,f.setLineDash(K)),f.lineTo(m,t),u&&l.lineTo(m,t)):
(f.beginPath(),f.moveTo(m,t),u&&(l.beginPath(),l.moveTo(m,t)),D={x:m,y:t}),ja=d=!1):(f.lineTo(m,t),u&&l.lineTo(m,t),0==k%250&&b());n={x:m,y:t};k<r.length-1&&(y!==(r[k].lineColor||w)||c!==(r[k].lineDashType||g.lineDashType))&&(b(),y=r[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[k].lineDashType?(c=r[k].lineDashType,f.setLineDash(O(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[k];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,
x1:m,y1:t};0!==r[k].markerSize&&(0<r[k].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(k,m,t,f),A.push(s),Y=Q(Y),u&&A.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[k].indexLabel||g.indexLabel||r[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[k],dataSeries:g,point:{x:m,y:t},direction:0>r[k].y===a.axisY.reversed?1:-1,color:z})}b();W.drawMarkers(A)}}u&&(e.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,
...
(s[s.length-1].newLineDashArray=y,z=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var K=n.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||B)||z!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||B,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(z=p[q].lineDashType,s[s.length-
1].newLineDashArray=O(z,n.lineThickness)):(z=n.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(q,g,r,b);l.push(aa);K=Q(K);u&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>
p[q].y===a.axisY.reversed?1:-1,color:C});r=!1}d();W.drawMarkers(l)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(v.x1,v.y1,v.width,v.height),this._eventManager.ghostCtx.restore());
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?B=C:0>a.axisY.viewportMaximum?B=v.y1:0<a.axisY.viewportMinimum&&(B=C),f.lineTo(m,B),f.lineTo(D.x,B),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,u&&(l.lineTo(m,B),l.lineTo(D.x,
B),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=u?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,v=a.axisY.lineCoordinates,A=[],h=this.plotArea,n;f.save();u&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();u&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],
g=this.data[q],r=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=Q(A);l.fillStyle=A;A=[];d=!0;var k=0,m,t,s,C=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),B,D=null;c=!1;if(0<r.length){var z=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||z,y=w;f.fillStyle=z;f.strokeStyle=w;f.lineWidth=g.lineThickness;var K="solid";if(f.setLineDash){var aa=O(g.nullDataLineDashType,g.lineThickness),K=g.lineDashType,
E=O(K,g.lineThickness);f.setLineDash(E)}for(;k<r.length;k++)if(s=r[k].x.getTime?r[k].x.getTime():r[k].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=t;"number"!==typeof r[k].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),t=a.axisY.convertValueToPixel(r[k].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||K===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),
f.moveTo(n.x,n.y),m=d,t=c,D=n,K=g.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(m,Y),f.lineTo(m,t),u&&(l.lineTo(m,Y),l.lineTo(m,t))):(f.beginPath(),f.moveTo(m,t),u&&(l.beginPath(),l.moveTo(m,t)),D={x:m,y:t}),c=d=!1):(f.lineTo(m,Y),u&&l.lineTo(m,Y),f.lineTo(m,t),u&&l.lineTo(m,t),0==k%250&&b()),n={x:m,y:t},k<r.length-1&&(y!==(r[k].lineColor||w)||K!==(r[k].lineDashType||g.lineDashType))&&(b(),y=r[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[k].lineDashType?(K=r[k].lineDashType,f.setLineDash(O(K,
g.lineThickness))):(K=g.lineDashType,f.setLineDash(E)))),s=g.dataPointIds[k],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:t},0!==r[k].markerSize&&(0<r[k].markerSize||0<g.markerSize)&&(Y=g.getMarkerProperties(k,m,t,f),A.push(Y),s=Q(s),u&&A.push({x:m,y:t,ctx:l,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[k].indexLabel||g.indexLabel||r[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",
dataPoint:r[k],dataSeries:g,point:{x:m,y:t},direction:0>r[k].y===a.axisY.reversed?1:-1,color:z}))}b();W.drawMarkers(A)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,
h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>h.length)){for(0<z.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);u&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();u&&(s.closePath(),s.fill(),s.beginPath());h=[]}}var c=
a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],v=this.plotArea,k=[],h=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,t,x,C;u&&s.beginPath();b.save();u&&s.save();b.beginPath();b.rect(v.x1,v.y1,v.width,v.height);b.clip();u&&(s.beginPath(),s.rect(v.x1,v.y1,v.width,v.height),s.clip());for(var e=[],B=0;B<a.dataSeriesIndexes.length;B++){var D=a.dataSeriesIndexes[B],
z=this.data[D],w=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<w.length;q++)D=w[q].x.getTime?w[q].x.getTime():w[q].x,z.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Oa)}for(B=0;B<a.dataSeriesIndexes.length;B++){D=a.dataSeriesIndexes[B];z=this.data[D];w=z.dataPoints;x=!0;h=[];q=z.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=Q(q);s.fillStyle=q;if(0<n.length){var e=z._colorSet[0],y=z.lineColor=z.options.lineColor||e,K=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=
z.lineThickness;C="solid";if(b.setLineDash){var aa=O(z.nullDataLineDashType,z.lineThickness);C=z.lineDashType;var E=O(C,z.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=z.dataPointIndexes[f]?w[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var ma=k[f]?k[f]:0;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=ma;h.push({x:g,y:m-ma});k[f]=m-r;x||Y?(!x&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||C===z.lineDashType&&z.lineDashType!==z.nullDataLineDashType)&&(x=h.pop(),C=h[h.length-1],d(),b.moveTo(t.x,t.y),h.push(C),h.push(x),C=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,
r),u&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),u&&(s.beginPath(),s.moveTo(g,r))),Y=x=!1):(b.lineTo(g,r),u&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),u&&s.moveTo(g,r),h.push({x:g,y:m-ma})));t={x:g,y:r};q<w.length-1&&(K!==(w[q].lineColor||y)||C!==(w[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),h.push({x:g,y:m-ma}),K=w[q].lineColor||y,b.strokeStyle=K,b.setLineDash&&(w[q].lineDashType?(C=w[q].lineDashType,b.setLineDash(O(C,z.lineThickness))):(C=z.lineDashType,b.setLineDash(E))));
if(0<=z.dataPointIndexes[f]){var F=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ma=z.getMarkerProperties(z.dataPointIndexes[f],g,r,b),l.push(ma),f=Q(F),u&&l.push({x:g,y:r,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||
z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);u&&s.moveTo(g,r)}delete z.dataPointIndexes}W.drawMarkers(l);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(v.x1,v.y1,v.width,v.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);u&&C.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();
b.globalAlpha=1;b.beginPath();u&&(C.closePath(),C.fill(),C.beginPath());h=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,v=[],k=[],h=[],n=[],p=[],q=0,g,r,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C=this._eventManager.ghostCtx;b.save();u&&C.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(C.beginPath(),C.rect(l.x1,l.y1,l.width,l.height),C.clip());
for(var e=[],B=0;B<a.dataSeriesIndexes.length;B++){var w=a.dataSeriesIndexes[B],z=this.data[w],y=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<y.length;q++)w=y[q].x.getTime?y[q].x.getTime():y[q].x,z.dataPointIndexes[w]=q,e[w]||(n.push(w),e[w]=!0);n.sort(Oa)}for(B=0;B<a.dataSeriesIndexes.length;B++){w=a.dataSeriesIndexes[B];z=this.data[w];y=z.dataPoints;s=!0;e=z.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:w};e=Q(e);C.fillStyle=e;h=[];if(0<n.length){var e=z._colorSet[q%
...
(Y||s)||d(),Y=!0;else{var ma;ma=0!==a.dataPointYSums[f]?100*(fa.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ba=k[f]?k[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ma+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ma),r-=ba;h.push({x:g,y:x-ba});k[f]=x-r;s||Y?(!s&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||t===z.lineDashType&&
z.lineDashType!==z.nullDataLineDashType)&&(s=h.pop(),t=h[h.length-1],d(),b.moveTo(m.x,m.y),h.push(t),h.push(s),t=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),u&&C.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),u&&(C.beginPath(),C.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),u&&C.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),u&&C.moveTo(g,r),h.push({x:g,y:x-ba})));m={x:g,y:r};q<y.length-1&&(K!==(y[q].lineColor||E)||t!==(y[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),h.push({x:g,y:x-
ba}),K=y[q].lineColor||E,b.strokeStyle=K,b.setLineDash&&(y[q].lineDashType?(t=y[q].lineDashType,b.setLineDash(O(t,z.lineThickness))):(t=z.lineDashType,b.setLineDash(F))));if(0<=z.dataPointIndexes[f]){var G=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ba=z.getMarkerProperties(q,g,r,b),v.push(ba),f=Q(G),
u&&v.push({x:g,y:r,ctx:C,type:ba.type,size:ba.size,color:f,borderColor:f,borderThickness:ba.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>y[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);u&&C.moveTo(g,r)}delete z.dataPointIndexes}W.drawMarkers(v);u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var v=-Infinity,k=Infinity,h=0;h<a.dataSeriesIndexes.length;h++)for(var n=a.dataSeriesIndexes[h],p=this.data[n],q=p.dataPoints,
g=0,e=0;e<q.length;e++)f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax||"undefined"===typeof q[e].z||(g=q[e].z,g>v&&(v=g),g<k&&(k=g));for(var r=25*Math.PI,m=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,r),h=0;h<a.dataSeriesIndexes.length;h++)if(n=a.dataSeriesIndexes[h],p=this.data[n],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,s=2*Math.max(Math.sqrt((v===k?m/2:r+(m-r)/(v-k)*(g-k))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;W.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var t=p.dataPointIds[e];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:s};
s=Q(t);u&&W.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],h=this.data[k],n=h.dataPoints;if(0<n.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,
b.width)/2,2);for(var p=0,q=0,e=0;e<n.length;e++)if(f=n[e].getTime?f=n[e].x.getTime():f=n[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(n[e].y);var g=h.getMarkerProperties(e,f,l,c);c.globalAlpha=h.fillOpacity;W.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,
this.plotArea.height)||(p=h.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:f,y1:l},p=Q(p),u&&W.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||h.indexLabel||n[e].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],dataSeries:h,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),
...
e&&(r=e);r>f&&(r=f);c.save();u&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();u&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var w=a.dataSeriesIndexes[m],t=this.data[w],x=t.dataPoints;if(0<x.length)for(var C=5<r&&t.bevelEnabled?!0:!1,v=0;v<x.length;v++)if(x[v].getTime?g=x[v].x.getTime():g=x[v].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[v].y)&&x[v].y.length&&"number"===typeof x[v].y[0]&&
"number"===typeof x[v].y[1]&&"number"===typeof x[v].y[2]&&"number"===typeof x[v].y[3]){k=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[v].y[0]);n=a.axisY.convertValueToPixel(x[v].y[1]);p=a.axisY.convertValueToPixel(x[v].y[2]);q=a.axisY.convertValueToPixel(x[v].y[3]);var B=k-r/2<<0,D=B+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[v].color?x[v].color:t._colorSet[0],z=Math.round(Math.max(1,0.15*r)),y=0===z%2?0:0.5,E=t.dataPointIds[v];this._eventManager.objectMap[E]=
{id:E,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:v,x1:B,y1:h,x2:D,y2:n,x3:k,y3:p,x4:k,y4:q,borderThickness:z,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=z;b.lineWidth=Math.max(z,4);"candlestick"===t.type?(c.moveTo(k-y,n),c.lineTo(k-y,Math.min(h,q)),c.stroke(),c.moveTo(k-y,Math.max(h,q)),c.lineTo(k-y,p),c.stroke(),ca(c,B,Math.min(h,q),D,Math.max(h,q),x[v].y[0]<=x[v].y[3]?t.risingColor:f,z,e,C,C,!1,!1,t.fillOpacity),u&&(e=Q(E),b.strokeStyle=e,b.moveTo(k-y,n),b.lineTo(k-y,Math.min(h,
q)),b.stroke(),b.moveTo(k-y,Math.max(h,q)),b.lineTo(k-y,p),b.stroke(),ca(b,B,Math.min(h,q),D,Math.max(h,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(k-y,n),c.lineTo(k-y,p),c.stroke(),c.beginPath(),c.moveTo(k,h),c.lineTo(B,h),c.stroke(),c.beginPath(),c.moveTo(k,q),c.lineTo(D,q),c.stroke(),u&&(e=Q(E),b.strokeStyle=e,b.moveTo(k-y,n),b.lineTo(k-y,p),b.stroke(),b.beginPath(),b.moveTo(k,h),b.lineTo(B,h),b.stroke(),b.beginPath(),b.moveTo(k,q),b.lineTo(D,q),b.stroke()));(x[v].indexLabel||t.indexLabel||
x[v].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:x[v],dataSeries:t,point:{x:B+(D-B)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:B,y1:Math.min(n,p),x2:D,y2:Math.max(n,p)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,
...
if(0<C.length)for(var B=5<r&&x.bevelEnabled?!0:!1,l=0;l<C.length;l++)if(C[l].getTime?g=C[l].x.getTime():g=C[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(C[l].y)&&C[l].y.length&&"number"===typeof C[l].y[0]&&"number"===typeof C[l].y[1]&&"number"===typeof C[l].y[2]&&"number"===typeof C[l].y[3]&&"number"===typeof C[l].y[4]&&5===C[l].y.length){v=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(C[l].y[0]);h=a.axisY.convertValueToPixel(C[l].y[1]);n=a.axisY.convertValueToPixel(C[l].y[2]);
p=a.axisY.convertValueToPixel(C[l].y[3]);q=a.axisY.convertValueToPixel(C[l].y[4]);var D=v-r/2<<0,z=v+r/2<<0,e=C[l].color?C[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*r)),E=0===y%2?0:0.5,K=C[l].whiskerColor?C[l].whiskerColor:C[l].color?x.whiskerColor?x.whiskerColor:C[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof C[l].whiskerThickness?C[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=C[l].whiskerDashType?C[l].whiskerDashType:x.whiskerDashType,
...
x.stemDashType,H=C[l].lineColor?C[l].lineColor:C[l].color?x.lineColor?x.lineColor:C[l].color:x.lineColor?x.lineColor:e,N="number"===typeof C[l].lineThickness?C[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,R=C[l].lineDashType?C[l].lineDashType:x.lineDashType,M=1===Math.round(N)%2?0.5:0,U=x.upperBoxColor,wa=x.lowerBoxColor,qa=s(x.options.fillOpacity)?1:x.fillOpacity,P=x.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,
x1:D,y1:k,x2:z,y2:h,x3:v,y3:n,x4:v,y4:p,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:ma,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=ba,c.setLineDash&&c.setLineDash(O(J,ba)),c.moveTo(v-G,h),c.lineTo(v-G,k),c.stroke(),c.moveTo(v-G,p),c.lineTo(v-G,n),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ca(c,D,Math.min(q,h),z,Math.max(h,q),wa,0,e,m?B:!1,m?!1:B,!1,!1,qa);c.beginPath();
ca(c,D,Math.min(n,q),z,Math.max(q,n),U,0,e,m?!1:B,m?B:!1,!1,!1,qa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(D-E,Math.min(h,n)-E,z-D+2*E,Math.max(h,n)-Math.min(h,n)+2*E);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(R,N)),c.strokeStyle=H,c.lineWidth=N,c.moveTo(D,q-M),c.lineTo(z,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(F,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(v-Y/2<<0,p-fa),c.lineTo(v+Y/2<<0,p-
fa),c.stroke(),c.moveTo(v-Y/2<<0,k+fa),c.lineTo(v+Y/2<<0,k+fa),c.stroke());c.restore();u&&(e=Q(P),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(v-E-G,h),b.lineTo(v-E-G,Math.max(k,p)),b.stroke(),b.moveTo(v-E-G,Math.min(k,p)),b.lineTo(v-E-G,n),b.stroke()),ca(b,D,Math.max(h,n),z,Math.min(h,n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(v+Y/2,p-fa),b.lineTo(v-Y/2,p-fa),b.stroke(),b.moveTo(v+Y/2,k+fa),b.lineTo(v-Y/2,k+fa),b.stroke()));(C[l].indexLabel||x.indexLabel||C[l].indexLabelFormatter||
x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:C[l],dataSeries:x,point:{x:D+(z-D)/2,y:a.axisY.reversed?k:p},direction:1,bounds:{x1:D,y1:Math.min(k,p),x2:z,y2:Math.max(k,p)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));h<f&&(h=f);h>l&&(h=l);c.save();u&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var p=a.dataSeriesIndexes[n],q=this.data[p],g=q.dataPoints;if(0<g.length)for(var r=
5<h&&q.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?k=g[f].x.getTime():k=g[f].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&!s(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(k);l=a.axisY.convertValueToPixel(g[f].y[0]);v=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*h/2-(a.previousDataSeriesCount+n)*h<<0:b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+
n)*h<<0,w=a.axisX.reversed?m-h<<0:m+h<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>v){var t=l;l=v;v=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:w,y2:v};ca(c,m,l,w,v,b,0,b,r,r,!1,!1,q.fillOpacity);b=Q(t);u&&ca(this._eventManager.ghostCtx,m,l,w,v,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",
...
(t=e);t>v&&(t=v);if(0<D.length)for(var F=B._colorSet,v=0;v<D.length;v++){var e=B.lineColor=B.options.color?B.options.color:F[0],K={color:D[v].whiskerColor?D[v].whiskerColor:D[v].color?B.whiskerColor?B.whiskerColor:D[v].color:B.whiskerColor?B.whiskerColor:e,thickness:s(D[v].whiskerThickness)?B.whiskerThickness:D[v].whiskerThickness,dashType:D[v].whiskerDashType?D[v].whiskerDashType:B.whiskerDashType,length:s(D[v].whiskerLength)?s(B.options.whiskerLength)?t:B.options.whiskerLength:D[v].whiskerLength,
trimLength:s(D[v].whiskerLength)?s(B.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=t?t:K.length:"string"===typeof K.length?parseInt(K.length)*t/100>t?t:parseInt(K.length)*t/100>t:t;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):2;var aa={color:D[v].stemColor?D[v].stemColor:D[v].color?B.stemColor?B.stemColor:D[v].color:B.stemColor?B.stemColor:e,thickness:D[v].stemThickness?D[v].stemThickness:B.stemThickness,dashType:D[v].stemDashType?
D[v].stemDashType:B.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[v].getTime?r=D[v].x.getTime():r=D[v].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[v].y)&&D[v].y.length&&"number"===typeof D[v].y[0]&&"number"===typeof D[v].y[1]){var ja=a.axisX.convertValueToPixel(r);b?h=ja:k=ja;ja=a.axisY.convertValueToPixel(D[v].y[0]);b?n=ja:q=ja;ja=a.axisY.convertValueToPixel(D[v].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?h+(z?
w:1)*t/2-(z?E-1:0)*t<<0:h-(z?w:1)*t/2+(z?E-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?k+(z?w:1)*t/2-(z?E-1:0)*t<<0:k-(z?w:1)*t/2+(z?E-1:0)*t<<0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&n>p&&(ja=n,n=p,p=ja);ja=B.dataPointIds[v];this._eventManager.objectMap[ja]={id:ja,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:v,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};y(c,Math.min(n,
p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,K,aa,b);u&&y(this._eventManager.ghostCtx,n,q,p,g,e,K,aa,b);if(D[v].indexLabel||B.indexLabel||D[v].indexLabelFormatter||B.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[v],dataSeries:B,indexKeyword:0,point:{x:b?D[v].y[1]>=D[v].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:D[v].y[1]>=D[v].y[0]?g:q},direction:D[v].y[1]>=D[v].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),
this._indexLabels.push({chartType:"error",dataPoint:D[v],dataSeries:B,indexKeyword:1,point:{x:b?D[v].y[1]>=D[v].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:D[v].y[1]>=D[v].y[0]?q:g},direction:D[v].y[1]>=D[v].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:
...
v=a.axisY.convertValueToPixel(r[f].y[1]);k=a.axisX.convertValueToPixel(h);k=a.axisX.reversed?k+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:k-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var w=a.axisX.reversed?k-n<<0:k+n<<0;l>v&&(b=l,l=v,v=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ca(c,l,k,v,w,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,
x1:l,y1:k,x2:v,y2:w};b=Q(b);u&&ca(this._eventManager.ghostCtx,l,k,v,w,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:v,y:k+(w-k)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,v),y1:k,x2:Math.max(l,v),y2:w},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=
r[f].y[0]?v:l,y:k+(w-k)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,v),y1:k,x2:Math.max(l,v),y2:w},color:b})}}}u&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(x){for(var a=null,c=m.length-1;0<=c;c--)a=m[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<m.length;c++)a=m[c],
...
for(var k=0;k<a.dataSeriesIndexes.length;k++){var m=[],h=a.dataSeriesIndexes[k],n=this.data[h],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,r,s,w,t,x=null;if(0<p.length){var C=n._colorSet[g%n._colorSet.length],B=n.lineColor=n.options.lineColor||C,D=B;b.fillStyle=C;b.strokeStyle=B;b.lineWidth=n.lineThickness;var z="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,n.lineThickness),z=n.lineDashType,E=O(z,
n.lineThickness);b.setLineDash(E)}for(var K=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!K)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);s=a.axisY.convertValueToPixel(p[g].y[0]);w=a.axisY.convertValueToPixel(p[g].y[1]);q||K?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||z===n.lineDashType&&
n.lineDashType!==n.nullDataLineDashType)&&(m[m.length-1].newLineDashArray=E,z=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,s),u&&e.lineTo(r,s),m.push({x:r,y1:s,y2:w})):(b.beginPath(),b.moveTo(r,s),x={x:r,y:s},m=[],m.push({x:r,y1:s,y2:w}),u&&(e.beginPath(),e.moveTo(r,s))),K=q=!1):(b.lineTo(r,s),m.push({x:r,y1:s,y2:w}),u&&e.lineTo(r,s),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:g,x1:r,y1:s,y2:w};g<p.length-
1&&(D!==(p[g].lineColor||B)||z!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||B,m[m.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(z=p[g].lineDashType,m[m.length-1].newLineDashArray=O(z,n.lineThickness),b.setLineDash(m[m.length-1].newLineDashArray)):(z=n.lineDashType,m[m.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,w,b);f.push(aa);var F=Q(t);u&&f.push({x:r,
y:w,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,r,s,b);f.push(aa);F=Q(t);u&&f.push({x:r,y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:C}),
this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:w},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:C})}else K||q||d(),K=!0;d();W.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
1].x,y[y.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),u&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=h.fillOpacity;b.fill();u&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<h.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(s[g].newStrokeStyle||s[g].newLineDashArray)b.stroke(),b.beginPath(),
...
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();u&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();u&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var k=0;k<a.dataSeriesIndexes.length;k++){var m=a.dataSeriesIndexes[k],h=this.data[m],n=h.dataPoints,f=h.id;this._eventManager.objectMap[f]=
{objectType:"dataSeries",dataSeriesIndex:m};f=Q(f);e.fillStyle=f;var f=[],p=0,q,g,r,s=[],y=[];if(0<n.length){var t=h._colorSet[p%h._colorSet.length],x=h.lineColor=h.options.lineColor||t,C=x;b.fillStyle=t;b.lineWidth=h.lineThickness;var B="solid",D;if(b.setLineDash){var z=O(h.nullDataLineDashType,h.lineThickness),B=h.lineDashType;D=O(B,h.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||
!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var E=h.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};y[y.length]={x:q,y:r};p<n.length-1&&(C!==(n[p].lineColor||x)||B!==(n[p].lineDashType||h.lineDashType))&&(C=n[p].lineColor||x,s[s.length-
1].newStrokeStyle=C,b.setLineDash&&(n[p].lineDashType?(B=n[p].lineDashType,s[s.length-1].newLineDashArray=O(B,h.lineThickness)):(B=h.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<h.markerSize)){var F=h.getMarkerProperties(p,q,g,b);f.push(F);var K=Q(E);u&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:K,borderColor:K,borderThickness:F.borderThickness});F=h.getMarkerProperties(p,q,r,b);f.push(F);K=Q(E);u&&f.push({x:q,y:r,ctx:e,type:F.type,size:F.size,
color:K,borderColor:K,borderThickness:F.borderThickness})}if(n[p].indexLabel||h.indexLabel||n[p].indexLabelFormatter||h.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:h,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:h,indexKeyword:1,point:{x:q,y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:t});g=!1}else 0<p&&!g&&(h.connectNullData?b.setLineDash&&
(0<s.length&&(h.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=z,B=h.nullDataLineDashType):(d(D,x),s=[],y=[])),g=!0;d(D,x);W.drawMarkers(f)}}u&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=u?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,k,m,h,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
n=w[l].x.getTime():n=w[l].x,"number"!==typeof w[l].y){if(0<l&&!B&&s.connectNullData)var E=s.options.nullDataLineDashType||!w[l-1].lineDashType?s.nullDataLineDashType:w[l-1].lineDashType;B=!0}else{k=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);h=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);k=a.axisX.reversed?k+a.plotType.totalDataSeries*
q/2-(a.previousDataSeriesCount+g)*q<<0:k-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var F=a.axisX.reversed?k-q<<0:k+q<<0;m>h&&(e=m,m=h,h=e);a.axisY.reversed&&(e=m,m=h,h=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:k,y1:m,x2:F,y2:h};var K=w[l].color?w[l].color:0<w[l].y?s.risingColor:s.fallingColor;ca(c,k,m,F,h,K,0,K,C,C,!1,!1,s.fillOpacity);e=Q(e);u&&ca(this._eventManager.ghostCtx,k,m,F,h,e,0,null,!1,
!1,!1,!1);var aa,K=k;aa="undefined"!==typeof w[l].isIntermediateSum&&!0===w[l].isIntermediateSum||"undefined"!==typeof w[l].isCumulativeSum&&!0===w[l].isCumulativeSum?0<w[l].y?m:h:0<w[l].y?h:m;0<l&&y&&(!B||s.connectNullData)&&(B&&c.setLineDash&&c.setLineDash(O(E,t)),c.beginPath(),c.moveTo(y,z-x),c.lineTo(K,aa-x),0<t&&c.stroke(),u&&(b.beginPath(),b.moveTo(y,z-x),b.lineTo(K,aa-x),0<t&&b.stroke()));B=!1;y=F;z=0<w[l].y?m:h;K=w[l].lineDashType?w[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
"shortDash";c.strokeStyle=w[l].lineColor?w[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(K=O(K,t),c.setLineDash(K));(w[l].indexLabel||s.indexLabel||w[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:w[l],dataSeries:s,point:{x:k+(F-k)/2,y:0<=w[l].y?m:h},direction:0>w[l].y===a.axisY.reversed?1:-1,bounds:{x1:k,y1:Math.min(m,h),x2:F,y2:Math.max(m,h)},color:e})}}u&&(d.drawImage(this._preRenderCanvas,0,
...
animationBase:0}}};var Z=function(a,d,c,b,e,f,l,k,m){if(!(0>c)){"undefined"===typeof k&&(k=1);if(!u){var h=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===h&&(l-=1E-4)}a.save();a.globalAlpha=k;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function d(){if(h&&n){for(var a=0,b=0,c=0,d=0,e=0;e<n.length;e++){var f=n[e],l=h.dataPointIds[e];g[e].id=l;g[e].objectType="dataPoint";g[e].dataPointIndex=e;g[e].dataSeriesIndex=0;var p=g[e],k={percent:null,total:null},v=null,k=m.getPercentAndTotal(h,f);if(h.indexLabelFormatter||f.indexLabelFormatter)v={chart:m.options,dataSeries:h,dataPoint:f,total:k.total,percent:k.percent};k=f.indexLabelFormatter?f.indexLabelFormatter(v):
f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,h,e):h.indexLabelFormatter?h.indexLabelFormatter(v):h.indexLabel?m.replaceKeywordsWithValue(h.indexLabel,f,h,e):f.label?f.label:"";m._eventManager.objectMap[l]=p;p.center={x:C.x,y:C.y};p.y=f.y;p.radius=z;p.percentInnerRadius=F;p.indexLabelText=k;p.indexLabelPlacement=h.indexLabelPlacement;p.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:h.options.indexLabelLineColor?h.options.indexLabelLineColor:f.color?f.color:h._colorSet[e%
h._colorSet.length];p.indexLabelLineThickness=s(f.indexLabelLineThickness)?h.indexLabelLineThickness:f.indexLabelLineThickness;p.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:h.indexLabelLineDashType;p.indexLabelFontColor=f.indexLabelFontColor?f.indexLabelFontColor:h.indexLabelFontColor;p.indexLabelFontStyle=f.indexLabelFontStyle?f.indexLabelFontStyle:h.indexLabelFontStyle;p.indexLabelFontWeight=f.indexLabelFontWeight?f.indexLabelFontWeight:h.indexLabelFontWeight;p.indexLabelFontSize=
s(f.indexLabelFontSize)?h.indexLabelFontSize:f.indexLabelFontSize;p.indexLabelFontFamily=f.indexLabelFontFamily?f.indexLabelFontFamily:h.indexLabelFontFamily;p.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:h.options.indexLabelBackgroundColor?h.options.indexLabelBackgroundColor:h.indexLabelBackgroundColor;p.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:h.indexLabelMaxWidth?h.indexLabelMaxWidth:0.33*q.width;p.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?
f.indexLabelWrap:h.indexLabelWrap;p.indexLabelTextAlign=f.indexLabelTextAlign?f.indexLabelTextAlign:h.indexLabelTextAlign?h.indexLabelTextAlign:"left";p.startAngle=0===e?h.startAngle?h.startAngle/180*Math.PI:0:g[e-1].endAngle;p.startAngle=(p.startAngle+2*Math.PI)%(2*Math.PI);p.endAngle=p.startAngle+2*Math.PI/B*Math.abs(f.y);f=(p.endAngle+p.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);p.midAngle=f;if(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>p.midAngle)c=e;a++}else if(p.midAngle>
...
1.5*p.indexLabelFontSize,text:p.indexLabelText,padding:0,textBaseline:"top"});p.indexLabelTextBlock.measureText()}l=f=0;k=!1;for(e=0;e<n.length;e++)p=g[(c+e)%n.length],1<a&&(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t)&&(f<=a/2&&!k?(p.hemisphere="right",f++):(p.hemisphere="left",k=!0));k=!1;for(e=0;e<n.length;e++)p=g[(d+e)%n.length],1<b&&(p.midAngle>3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t)&&(l<=b/2&&!k?(p.hemisphere="left",l++):(p.hemisphere="right",k=!0))}}function c(a){var b=m.plotArea.ctx;b.clearRect(q.x1,
...
l=!0;l&&(e={},e.dataSeries=h,e.dataPoint=h.dataPoints[b],e.index=b,m.toolTip.highlightObjects([e]));Z(m.plotArea.ctx,g[b].center,g[b].radius,n[b].color?n[b].color:h._colorSet[b%h._colorSet.length],h.type,c,d,h.fillOpacity,g[b].percentInnerRadius)}}a=m.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<n.length;b++)c=g[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=c.indexLabelTextBlock.height/2,d=0,d="left"===c.hemisphere?"inside"!==
h.indexLabelPlacement?-(c.indexLabelTextBlock.width+p):-c.indexLabelTextBlock.width/2:"inside"!==h.indexLabelPlacement?p:-c.indexLabelTextBlock.width/2,c.indexLabelTextBlock.x+=d,c.indexLabelTextBlock.render(!0),c.indexLabelTextBlock.x-=d,c.indexLabelTextBlock.y+=c.indexLabelTextBlock.height/2,"inside"!==c.indexLabelPlacement&&0<c.indexLabelLineThickness&&(d=c.center.x+z*Math.cos(c.midAngle),e=c.center.y+z*Math.sin(c.midAngle),a.strokeStyle=c.indexLabelLineColor,a.lineWidth=c.indexLabelLineThickness,
...
l=C.y-1*u,p=C.y+1*u;if(0<=a&&a<n.length){var q=g[a];if(0>c&&q.indexLabelTextBlock.y<l||0<c&&q.indexLabelTextBlock.y>p)return 0;var k=0,m=0,m=k=k=0;0>c?q.indexLabelTextBlock.y-q.indexLabelTextBlock.height/2>l&&q.indexLabelTextBlock.y-q.indexLabelTextBlock.height/2+c<l&&(c=-(l-(q.indexLabelTextBlock.y-q.indexLabelTextBlock.height/2+c))):q.indexLabelTextBlock.y+q.indexLabelTextBlock.height/2<l&&q.indexLabelTextBlock.y+q.indexLabelTextBlock.height/2+c>p&&(c=q.indexLabelTextBlock.y+q.indexLabelTextBlock.height/
2+c-p);c=q.indexLabelTextBlock.y+c;l=0;l="right"===q.hemisphere?C.x+Math.sqrt(Math.pow(u,2)-Math.pow(c-C.y,2)):C.x-Math.sqrt(Math.pow(u,2)-Math.pow(c-C.y,2));m=C.x+z*Math.cos(q.midAngle);k=C.y+z*Math.sin(q.midAngle);k=Math.sqrt(Math.pow(l-m,2)+Math.pow(c-k,2));m=Math.acos(z/u);k=Math.acos((u*u+z*z-k*k)/(2*z*u));c=k<m?c-q.indexLabelTextBlock.y:0;l=null;for(p=1;p<n.length;p++)if(l=(a-p+g.length)%g.length,g[l].hemisphere!==g[a].hemisphere){l=null;break}else if(g[l].indexLabelText&&g[l].hemisphere===
g[a].hemisphere&&l!==a&&(0>b(g[l],g[a])||("right"===g[a].hemisphere?g[l].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y:g[l].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else l=null;m=l;k=e(a);p=l=0;0>c?(p="right"===q.hemisphere?m:k,h=c,null!==p&&(m=-c,c=q.indexLabelTextBlock.y-q.indexLabelTextBlock.height/2-(g[p].indexLabelTextBlock.y+g[p].indexLabelTextBlock.height/2),c-m<r&&(l=-m,p=f(p,l,d+1),+p.toFixed(x)>+l.toFixed(x)&&(h=c>r?-(c-r):-(m-(p-l)))))):0<c&&(p="right"===q.hemisphere?
k:m,h=c,null!==p&&(m=c,c=g[p].indexLabelTextBlock.y-g[p].indexLabelTextBlock.height/2-(q.indexLabelTextBlock.y+q.indexLabelTextBlock.height/2),c-m<r&&(l=m,p=f(p,l,d+1),+p.toFixed(x)<+l.toFixed(x)&&(h=c>r?c-r:m-(l-p)))));h&&(d=q.indexLabelTextBlock.y+h,c=0,c="right"===q.hemisphere?C.x+Math.sqrt(Math.pow(u,2)-Math.pow(d-C.y,2)):C.x-Math.sqrt(Math.pow(u,2)-Math.pow(d-C.y,2)),q.midAngle>Math.PI/2-t&&q.midAngle<Math.PI/2+t?(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===q.hemisphere&&
"right"===l.hemisphere&&c>l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x-15:"right"===q.hemisphere&&("left"===a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):q.midAngle>3*Math.PI/2-t&&q.midAngle<3*Math.PI/2+t&&(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"right"===q.hemisphere&&"left"===l.hemisphere&&c<l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x+15:"left"===q.hemisphere&&("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-
15)),q.indexLabelTextBlock.y=d,q.indexLabelTextBlock.x=c,q.indexLabelAngle=Math.atan2(q.indexLabelTextBlock.y-C.y,q.indexLabelTextBlock.x-C.x))}return h}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(h.radius||!h.radius&&"undefined"!==typeof h.innerRadius&&null!==h.innerRadius&&z-d<=E)l=!1;l&&(z-=d);d=0;if("inside"!==h.indexLabelPlacement){u=z*w;for(a=0;a<n.length;a++){var k=
g[a];k.indexLabelTextBlock.x=C.x+u*Math.cos(k.midAngle);k.indexLabelTextBlock.y=C.y+u*Math.sin(k.midAngle);k.indexLabelAngle=k.midAngle;k.radius=z;k.percentInnerRadius=F}for(var v,s,a=0;a<n.length;a++){var k=g[a],t=e(a);if(null!==t){v=g[a];s=g[t];var B=0,B=b(v,s)-r;if(0>B){for(var y=s=0,D=0;D<n.length;D++)D!==a&&g[D].hemisphere===k.hemisphere&&(g[D].indexLabelTextBlock.y<k.indexLabelTextBlock.y?s++:y++);s=B/(s+y||1)*y;var y=-1*(B-s),J=D=0;"right"===k.hemisphere?(D=f(a,s),y=-1*(B-D),J=f(t,y),+J.toFixed(x)<
+y.toFixed(x)&&+D.toFixed(x)<=+s.toFixed(x)&&f(a,-(y-J))):(D=f(t,s),y=-1*(B-D),J=f(a,y),+J.toFixed(x)<+y.toFixed(x)&&+D.toFixed(x)<=+s.toFixed(x)&&f(t,-(y-J)))}}}}else for(a=0;a<n.length;a++)k=g[a],u="pie"===h.type?0.7*z:0.8*z,t=C.x+u*Math.cos(k.midAngle),s=C.y+u*Math.sin(k.midAngle),k.indexLabelTextBlock.x=t,k.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(k=g[a],t=k.indexLabelTextBlock.measureText(),0!==t.height&&0!==t.width)t=t=0,"right"===k.hemisphere?(t=q.x2-(k.indexLabelTextBlock.x+k.indexLabelTextBlock.width+
p),t*=-1):t=q.x1-(k.indexLabelTextBlock.x-k.indexLabelTextBlock.width-p),0<t&&(!l&&k.indexLabelText&&(s="right"===k.hemisphere?q.x2-k.indexLabelTextBlock.x:k.indexLabelTextBlock.x-q.x1,0.3*k.indexLabelTextBlock.maxWidth>s?k.indexLabelText="":k.indexLabelTextBlock.maxWidth=0.85*s,0.3*k.indexLabelTextBlock.maxWidth<s&&(k.indexLabelTextBlock.x-="right"===k.hemisphere?2:-2)),Math.abs(k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2-C.y)<z||Math.abs(k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/
2-C.y)<z)&&(t/=Math.abs(Math.cos(k.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)),t=t=0,0<k.indexLabelAngle&&k.indexLabelAngle<Math.PI?(t=q.y2-(k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/2+5),t*=-1):t=q.y1-(k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2-5),0<t&&(!l&&k.indexLabelText&&(s=0<k.indexLabelAngle&&k.indexLabelAngle<Math.PI?-1:1,0===f(a,t*s)&&f(a,2*s)),Math.abs(k.indexLabelTextBlock.x-C.x)<z&&(t/=Math.abs(Math.sin(k.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)));var H=function(a,
b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,h=0;h<n.length;h++)if(f=!1,v=g[h],v.indexLabelText){var l=e(h);if(null!==l){var k=g[l];B=0;B=b(v,k);var q;if(q=0>B){q=v.indexLabelTextBlock.x;var m=v.indexLabelTextBlock.y-v.indexLabelTextBlock.height/
2,r=v.indexLabelTextBlock.y+v.indexLabelTextBlock.height/2,s=k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2,t=k.indexLabelTextBlock.x+k.indexLabelTextBlock.width,A=k.indexLabelTextBlock.y+k.indexLabelTextBlock.height/2;q=v.indexLabelTextBlock.x+v.indexLabelTextBlock.width<k.indexLabelTextBlock.x-p||q>t+p||m>A+p||r<s-p?!1:!0}q?(0>a&&(a=h),l!==a&&(c=l,d+=-B),0===h%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(H(d,a,c),c=a=-1,d=0)}}0<d&&H(d,a,c)})()}}function k(){m.plotArea.layoutManager.reset();
...
this.data[a.dataSeriesIndexes[0]],n=h.dataPoints,p=10,q=this.plotArea,g=h.dataPointEOs,r=2,u,w=1.3,t=20/180*Math.PI,x=6,C={x:(q.x2+q.x1)/2,y:(q.y2+q.y1)/2},B=0;a=!1;for(var y=0;y<n.length;y++)B+=Math.abs(n[y].y),!a&&("undefined"!==typeof n[y].indexLabel&&null!==n[y].indexLabel&&0<n[y].indexLabel.toString().length)&&(a=!0),!a&&("undefined"!==typeof n[y].label&&null!==n[y].label&&0<n[y].label.toString().length)&&(a=!0);if(0!==B){a=a||"undefined"!==typeof h.indexLabel&&null!==h.indexLabel&&0<h.indexLabel.toString().length;
var z="inside"!==h.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,q.height)/2;h.radius&&(z=Qa(h.radius,z));var E="undefined"!==typeof h.innerRadius&&null!==h.innerRadius?Qa(h.innerRadius,z):0.7*z;h.radius=z;"doughnut"===h.type&&(h.innerRadius=E);var F=Math.min(E/z,(z-1)/z);this.pieDoughnutClickHandler=function(a){m.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&m._animator.animate(0,
500,function(a){c(a);k();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});m.dispatchEvent("dataAnimationEnd",{chart:m})}))};d();l();l();l();l();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<n.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),
f=!1;e>b&&(e=b,f=!0);var l=n[c].color?n[c].color:h._colorSet[c%h._colorSet.length];e>d&&Z(m.plotArea.ctx,g[c].center,g[c].radius,l,h.type,d,e,h.fillOpacity,g[c].percentInnerRadius);if(f)break}k();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});1<=a&&m.dispatchEvent("dataAnimationEnd",{chart:m})},function(){m.disableToolTip=!1;m._animator.animate(0,m.animatedRender?500:0,function(a){c(a);k();m.dispatchEvent("dataAnimationIterationEnd",{chart:m})});m.dispatchEvent("dataAnimationEnd",{chart:m})})}}};
...
function(a){function d(){for(var a=0,b=[],c=0;c<x.length;c++){if("undefined"===typeof x[c].y)return-1;x[c].y="number"===typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*E/a);return b}function c(){var a=V,b=X,c=M,d=W,e,f;e=Y;f=R-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=W-M;e=f-e;f=c*(f-R);f=Math.abs(f);f=d+f;for(var d=[],g=0,h=0;h<x.length;h++){if("undefined"===typeof x[h].y)return-1;x[h].y="number"===typeof x[h].y?x[h].y:0;g+=Math.abs(x[h].y)}if(0===
g)return-1;for(var l=d[0]=0,n=0,p,k,b=b-a,l=!1,h=0;h<x.length;h++)a=Math.abs(x[h].y)*f/g,l?p=0==Number(c.toFixed(3))?0:a/c:(k=$*$*b*b-4*Math.abs($)*a,0>k?(k=c,l=(b+k)*(e-n)/2,a-=l,p=e-n,n+=e-n,p+=0==k?0:a/k,n+=a/k,l=!0):(p=(Math.abs($)*b-Math.sqrt(k))/2,k=b-2*p/Math.abs($),n+=p,n>e&&(n-=p,k=c,l=(b+k)*(e-n)/2,a-=l,p=e-n,n+=e-n,p+=a/k,n+=a/k,l=!0),b=k)),d.push(p);return d}function b(){if(t&&x){for(var a,b,c,d,e,f,h,l,n,p,k,q,m,v,r,A=[],w=[],C={percent:null,total:null},B=null,z=0;z<x.length;z++)r=P[z],
r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,A[z]=N-r-U;r=0.5*U;for(var z=0,D=x.length-1;z<x.length||0<=D;z++,D--){b=t.reversed?x[D]:x[z];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-z)%t._colorSet.length]:t._colorSet[z%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";v=b.indexLabelTextAlign||t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(u?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||
"#979797";f=s(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;h=b.indexLabelFontStyle||t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||"arial";n=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||t.options.indexLabelLineColor||a;p="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;k=b.indexLabelLineDashType||t.indexLabelLineDashType||
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;m=t.dataPointIds[z];y._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-z:z]};"inside"===t.indexLabelPlacement&&(A[z]=z!==ca?t.reversed?P[z].x2-P[z].x1:P[z].x3-P[z].x4:P[z].x3-P[z].x6,20>A[z]&&(A[z]=z!==ca?t.reversed?P[z].x3-P[z].x4:P[z].x2-P[z].x1:P[z].x2-P[z].x1,A[z]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
...
b.label:"";0>=p&&(p=0);1E3>m&&1E3-m<r&&(m+=1E3-m);Q.roundRect||Aa(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:h,fontWeight:n,horizontalAlign:c,textAlign:v,backgroundColor:d,maxWidth:m,maxHeight:!1===w[z]?q?4.28571429*f:1.5*f:w[z],text:b,padding:da});c.measureText();I.push({textBlock:c,id:t.reversed?D:z,isDirty:!1,lineColor:a,lineThickness:p,lineDashType:k,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,h=N-X-U/2,h=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>h?h:t.indexLabelMaxWidth:h,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||h;if(c>h||0>c)c=h;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=N-h,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:
...
c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=t.reversed?"undefined"!==typeof a.x5?c>wa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<wa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,t.reversed?(I[e].textBlock.y+I[e].height>S+B&&(I[e].textBlock.y=S+B-I[e].height),I[e].textBlock.y<qa-B&&(I[e].textBlock.y=
...
d=k(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=k(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,h;f=(R-Y+2*B)/n;h=n;for(var l,k=1;k<h;k++){e=k*f;for(var m=I.length-1;0<=m;m--)!I[m].isDirty&&(I[m].textBlock.y<e&&I[m].textBlock.y+I[m].height>e)&&(l=q(m),!(l>=I.length-1)&&I[m].textBlock.y+I[m].height+da>I[l].textBlock.y&&(I[m].textBlock.y=I[m].textBlock.y+
I[m].height-e>e-I[m].textBlock.y?e+1:e-I[m].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=p(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(h=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;h+=I[f].height;h+=da;f=e;if(0>=f){f=0;h+=I[f].height;break}e=p(f);if(0>e){f=0;h+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;a-=g;a=h-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,h,l,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,l=(h=q(r)<P.length?I[q(r)]:null)?h.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(h&&e+d+da>+l.y.toFixed(6))&&(d=g.y+d+da-l.y,
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function k(a,b){return(b<P.length?I[b].textBlock.y:t.reversed?S+B:qa+B)-(0>a?t.reversed?qa-B:S-B:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],p=B,k=[];-1!==b&&(0<=Z.indexOf(b)?(e=Z.indexOf(b),Z.splice(e,1)):(Z.push(b),Z=Z.sort(function(a,b){return a-b})));if(0===Z.length)l=ga;else{e=B*(1!=Z.length||0!=Z[0]&&Z[0]!=P.length-1?2:1)/h();for(var q=0;q<P.length;q++){if(1==Z.length&&0==Z[0]){if(0===q){l.push(ga[q]);d=p;continue}}else 0===
q&&(d=-1*p);l.push(ga[q]+d);if(0<=Z.indexOf(q)||q<P.length&&0<=Z.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var v={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof k[d]&&(k[d]=0),0>k&&(k*=-1),c.y1+=b-k[d],c.y2+=b-k[d],c.y3+=b-k[d],c.y4+=b-k[d],c.y5&&(c.y5+=b-k[d],c.y6+=b-k[d]),k[d]=
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ha=!0;d.clearRect(C.x1,C.y1,C.x2-C.x1,C.y2-C.y1);d.fillStyle=a.backgroundColor;d.fillRect(C.x1,C.y1,C.width,C.height);v.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[x.length-1-b]:t.dataPoints[b];e.index=t.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)oa(d,P[e],t.fillOpacity);w(d);K&&("inside"!==t.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ha=!1)},null,L.easing.easeOutQuart)}
function h(){for(var a=0,b=0;b<P.length-1;b++)(0<=Z.indexOf(b)||0<=Z.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(O(I[f].lineDashType,I[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}
...
typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=ba=0,t.reversed=t.reversed?!1:!0);var D=H+a/2,V=H,X=H+a,S=t.reversed?R:Y,M=D-G/2,W=D+G/2,wa=t.reversed?Y+ba:R-ba,qa=t.reversed?Y:R;a=[];var D=[],P=[],F=[],T=Y,ca,$=(wa-S)/(M-V),ea=-$,H="area"===(t.valueRepresents?t.valueRepresents:"height")?c():d();if(-1!==H){if(t.reversed)for(F.push(T),
G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(t.reversed)for(G=0;G<H.length;G++)F[G]<wa?(a.push(M),D.push(W),ca=G):(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*X)/ea));else for(G=0;G<H.length;G++)F[G]<wa?(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*X)/ea),ca=G):(a.push(M),D.push(W));for(G=0;G<H.length-1;G++)T=t.reversed?x[x.length-1-G].color?x[x.length-1-G].color:t._colorSet[(x.length-1-G)%t._colorSet.length]:x[G].color?x[G].color:t._colorSet[G%t._colorSet.length],
G===ca?P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:W,y3:wa,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:M,y6:wa,id:G,height:F[G+1]-F[G],color:T}):P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ha=!1,Z=[],ga=[],H=!1;a=a=0;Ba(Z);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,t.reversed?Z.push(x.length-1-G):Z.push(G));Q.clearRect(C.x1,C.y1,C.width,C.height);Q.fillStyle=y.backgroundColor;Q.fillRect(C.x1,C.y1,C.width,C.height);
...
e=isNaN(d.y)?0:100*(d.y/b)}return{percent:e,total:b}};m.prototype.replaceKeywordsWithValue=function(a,d,c,b,e){var f=this;e="undefined"===typeof e?0:e;if((0<=c.type.indexOf("stacked")||"pie"===c.type||"doughnut"===c.type||"funnel"===c.type||"pyramid"===c.type)&&(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))){var l="#percent",k="#total",m=this.getPercentAndTotal(c,d),k=isNaN(m.total)?k:m.total,l=isNaN(m.percent)?l:m.percent;do{m="";if(c.percentFormatString)m=c.percentFormatString;else{var m="#,##0.",
h=Math.max(Math.ceil(Math.log(1/Math.abs(l))/Math.LN10),2);if(isNaN(h)||!isFinite(h))h=2;for(var n=0;n<h;n++)m+="#";c.percentFormatString=m}a=a.replace("#percent",ea(l,m,f._cultureInfo));a=a.replace("#total",ea(k,c.yValueFormatString?c.yValueFormatString:"#,##0.########",f._cultureInfo))}while(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=Ea(a.slice(1,
a.length-1));a=a.replace("#index",e);var h=null;try{var g=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);g&&0<g.length&&(h=Ea(g[2]),a=Ea(g[1]))}catch(l){}g=null;if("color"===a)return"waterfall"===c.type?d.color?d.color:0<d.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[h%c._colorSet.length]:d.color?d.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(d.hasOwnProperty(a))g=d;else if(c.hasOwnProperty(a))g=c;else return"";g=g[a];null!==h&&(g=g[h]);if("x"===a)if(c.axisX&&"dateTime"===
...
p.legendMarkerColor?p.legendMarkerColor:C.color?C.color:p.color?p.color:p._colorSet[x%p._colorSet.length],u=0.75*this.lineHeight,w=C.legendMarkerBorderColor?C.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:C.markerBorderColor?C.markerBorderColor:p.markerBorderColor,t=C.legendMarkerBorderThickness?C.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:C.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*u)):0,g=this.chart.replaceKeywordsWithValue(g,
C,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:u,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:t};(C.showInLegend||p.showInLegend&&!1!==C.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=C=x=0;C=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
f;u=0===u?0.75*this.lineHeight:u;C-=u+k;for(n=0;n<m.length;n++){q=m[n];w=C;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=w||"undefined"===typeof w)){if("horizontal"===this.orientation){q.textBlock=new ia(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(u+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+Math.round(q.textBlock.width+u+k+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)p={items:[],width:0},h.push(p),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=
new ia(this.ctx,{x:0,y:0,maxWidth:C,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(u+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(p={items:[],
width:0},h.push(p)):(p=h[x],x=(x+1)%h.length),this.height+=q.textBlock.height;q.textBlock.x=p.width;q.textBlock.y=0;p.width+=Math.round(q.textBlock.width+u+k+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=Math.max(p.width,this.width);r=q.textBlock.width+(u+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=r;this.height=
...
d.x1:"right"===this.horizontalAlign?d.x2-this.width:d.x1+d.width/2-this.width/2,b=d.y2-this.height);this.items=m;for(n=0;n<this.items.length;n++)q=m[n],q.id=++this.chart._eventManager.lastObjectId,this.chart._eventManager.objectMap[q.id]={id:q.id,objectType:"legendItem",legendItemIndex:n,dataSeriesIndex:q.dataSeriesIndex,dataPointIndex:q.dataPointIndex};this.markerSize=u;this.rows=h;0<m.length&&a.layoutManager.registerSpace(c,{width:this.width+2+2,height:this.height+5+5});this.bounds={x1:e,y1:b,x2:e+
this.width,y2:b+this.height}};F.prototype.render=function(){var a=this.bounds.x1,d=this.bounds.y1,c=this.markerMargin,b=this.maxWidth,e=this.maxHeight,f=this.markerSize,l=this.rows;(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(a,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var k=0,m=0;m<l.length;m++){for(var h=l[m],n=0,p=0;p<h.items.length;p++){var q=h.items[p],g=q.textBlock.x+a+(0===p?0.2*f:this.horizontalSpacing),
...
0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var u=g-0.08*this.lineHeight+0.1*this.lineHeight,t=r+0.15*this.lineHeight,x=0.7*this.lineHeight,w=x+0.02*this.lineHeight;this.ctx.moveTo(u,t);this.ctx.lineTo(u+x,t);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(u+x/2,t);this.ctx.lineTo(u+x/2,t+w);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(u,t+w);this.ctx.lineTo(u+x,t+w);this.ctx.stroke();this.errorMarkerColor.shift()}W.drawMarker(g+
...
2}k+=n}};na(H,V);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===
...
index:NaN},b=null,e=0,f=0,l=1,k=Infinity,m=0,h=0,n=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(n=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),n=1<n?Math.min(Math.max((this.dataPoints.length-1)/n*Math.log(a/this.dataPoints[0].x)>>0,0),this.dataPoints.length):0):(n=this.dataPoints[this.dataPoints.length-1].x-this.dataPoints[0].x,n=0<n?Math.min(Math.max((this.dataPoints.length-1)/n*(a-this.dataPoints[0].x)>>0,0),this.dataPoints.length):0));for(;;){f=
0<l?n+e:n-e;if(0<=f&&f<this.dataPoints.length){var b=this.dataPoints[f],p=this.axisX.logarithmic?b.x>a?b.x/a:a/b.x:Math.abs(b.x-a);p<c.distance&&(c.dataPoint=b,c.distance=p,c.index=f);b=p;b<=k?k=b:0<l?m++:h++;if(1E3<m&&1E3<h)break}else if(0>n-e&&n+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}return d||(c.dataPoint.x.getTime?c.dataPoint.x.getTime():c.dataPoint.x)!==(a.getTime?a.getTime():a)?d&&null!==c.dataPoint?c:null:c};H.prototype.getDataPointAtXY=function(a,d,c){if(!this.dataPoints||0===
this.dataPoints.length||a<this.chart.plotArea.x1||a>this.chart.plotArea.x2||d<this.chart.plotArea.y1||d>this.chart.plotArea.y2)return null;c=c||!1;var b=[],e=0,f=0,l=1,k=!1,m=Infinity,h=0,n=0,p=0;if("none"!==this.chart.plotInfo.axisPlacement)if(p=(this.chart.axisX[0]?this.chart.axisX[0]:this.chart.axisX2[0]).getXValueAt({x:a,y:d}),this.axisX.logarithmic)var q=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),p=1<q?Math.min(Math.max((this.dataPoints.length-1)/q*Math.log(p/
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),k=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=la("markerSize",g,this)||4,u=c?20:s,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?h++:n++;r<=s/2&&(k=!0);break;case "rangeArea":case "rangeSplineArea":s=la("markerSize",g,this)||4;u=c?20:s;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?h++:n++;r<=s/2&&(k=!0);break;case "bubble":s=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
distance:r}),k=!0);break;case "pie":case "doughnut":s=q.center;u="doughnut"===this.type?q.percentInnerRadius*q.radius:0;r=Math.sqrt(Math.pow(s.x-a,2)+Math.pow(s.y-d,2));r<q.radius&&r>u&&(r=Math.atan2(d-s.y,a-s.x),0>r&&(r+=2*Math.PI),r=Number(((180*(r/Math.PI)%360+360)%360).toFixed(12)),s=Number(((180*(q.startAngle/Math.PI)%360+360)%360).toFixed(12)),u=Number(((180*(q.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===u&&1<q.endAngle&&(u=360),s>=u&&0!==g.y&&(u+=360,r<s&&(r+=360)),r>s&&r<u&&(b.push({dataPoint:g,
...
Math.abs(q.x2-a),Math.abs(q.y2-d),Math.abs(q.y3-d))}),k=!0}if(k||1E3<h&&1E3<n)break}}else if(0>p-e&&p+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}a=null;for(d=0;d<b.length;d++)a?b[d].distance<=a.distance&&(a=b[d]):a=b[d];return a};H.prototype.getMarkerProperties=function(a,d,c,b){var e=this.dataPoints;return{x:d,y:c,ctx:b,type:e[a].markerType?e[a].markerType:this.markerType,size:e[a].markerSize?e[a].markerSize:this.markerSize,color:e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:
...
0;g<a.length;g++)a[g]&&(a[g].lineCoordinates.x1=l,m=Math.round(f.x2-$-Z>n.width-p?n.width-p:f.x2-$-Z),a[g]._labels&&1<a[g]._labels.length&&(k=h=0,h=a[g]._labels[1],k="dateTime"===a[g].valueType?a[g]._labels[a[g]._labels.length-2]:a[g]._labels[a[g]._labels.length-1],w=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),t=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-
k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(z)||s(E)||n.isNavigator||n.stockChart)||(k=0,0<a[g].labelAngle?E+t>m&&(k+=0<a[g].labelAngle?E+t-m-$:0):0>a[g].labelAngle?z-w<l&&z-w<a[g].viewportMinimum&&(F=l-(M+a[g].tickLength+B+z-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+t>m&&(k=E+t/2-m-$),z-w<l&&z-w<a[g].viewportMinimum&&(F=l-M-a[g].tickLength-B-z+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<k?m-=k:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<F?l+=F:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<F&&(l+=F),0<k&&(m-=k))),n.panEnabled?T=s(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=T:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=T,k=Math.round(f.y2-T-e+G),h=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
...
Math.round(f.x2-$-Z>n.width-p?n.width-p:f.x2-$-Z),d[g].lineCoordinates.width=Math.abs(m-l),d[g]._labels&&1<d[g]._labels.length&&(h=d[g]._labels[1],k="dateTime"===d[g].valueType?d[g]._labels[d[g]._labels.length-2]:d[g]._labels[d[g]._labels.length-1],w=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),t=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-
k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle))),n.panEnabled?W=s(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=W:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=W,k=Math.round(f.y1),h=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=k+W+X-U,d[g].lineCoordinates.y2=k,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-y[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:k+(W+
X-y[g]-U),x2:m,y2:h,width:m-l,height:h-k},U+=y[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)M=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,k=Math.round(f.y1+W+X<Math.max(M,p)?Math.max(M,p):f.y1+W+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),M=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,h=Math.round(f.y2-T-e-M),c[g].lineCoordinates={x1:l-S,y1:k,x2:m-S,y2:h,height:Math.abs(h-k)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(B[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(B[g]+S),y1:k,x2:m,y2:h,width:m-l,height:h-k},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),S+=B[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),M=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,k=Math.round(f.y1+W+X<Math.max(M,p)?Math.max(M,p):f.y1+W+X),M=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,h=Math.round(f.y2-(T+e+M)),b[g].lineCoordinates=
{x1:l+V,y1:k,x2:l+V,y2:h,height:Math.abs(h-k)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(D[g]-(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0))-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:k,x2:m+(D[g]+V),y2:h,width:m-l,height:h-k},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)r=N[u-1][g]===N[u][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=O[u-1][g]===O[u][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=Q[u-1][g]===Q[u][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=R[u-
1][g]===R[u][g]?!0:!1;else L=!0}if(r&&H&&J&&L)break;u++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels()}else{p=
[];z=[];F=[];w=[];E=[];t=[];N=[];for(O=[];4>u;){T=V=U=S=Z=M=X=e=R=Q=G=W=0;if(a&&0<a.length)for(F=[],g=V=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),V+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(F);if(d&&0<d.length)for(w=[],g=T=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=w[g],X+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
...
b[0].createLabelsAndCalculateHeight():0));t.push(z);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(h=c[g]._labels[0],k=c[g]._labels[c[g]._labels.length-1],x=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),y=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)));
if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&0<b[g]._labels.length&&(h=b[g]._labels[0],k=b[g]._labels[b[g]._labels.length-1],B=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),D=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)));if(n.panEnabled)for(g=0;g<c.length;g++)p[g]=s(n.sessionVariables.axisY.height)?
n.sessionVariables.axisY.height=p[g]:n.sessionVariables.axisY.height;else for(g=0;g<c.length;g++)n.sessionVariables.axisY.height=p[g];if(c&&0<c.length)for(g=c.length-1;0<=g;g--)k=Math.round(f.y2),h=Math.round(f.y2>c[g].chart.height?c[g].chart.height:f.y2),c[g].lineCoordinates.y1=k-(p[g]+c[g].margin+W),c[g].lineCoordinates.y2=k-(p[g]+c[g].margin+W),"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+p[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)-("inside"===
c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:k-(p[g]+W+c[g].margin),x2:m,y2:h-(W+c[g].margin),width:m-l,height:p[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),W+=p[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(k=Math.round(f.y1),h=Math.round(f.y1+(z[g]+b[g].margin+G)),b[g].lineCoordinates.y1=
h,b[g].lineCoordinates.y2=h,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=h-z[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)),b[g].bounds={x1:l,y1:k+(b[g].margin+G),x2:m,y2:h,width:m-l,height:U},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),G+=z[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){M=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/
2:0;l=Math.round(f.x1+e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;m=Math.round(f.x1+V+e);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-S>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-S):f.y2>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(m=0>c[M].labelAngle?Math.max(m,x):0===c[M].labelAngle?Math.max(m,x/2):m,l=
0>c[M].labelAngle||0===c[M].labelAngle?m-V:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&b[M].labelAutoFit&&(m=b[M].lineCoordinates.x1,l=m-V);a[g].lineCoordinates={x1:m-Q,y1:k,x2:m-Q,y2:h,height:Math.abs(h-k)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(F[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(F[g]+
Q),y1:k,x2:m,y2:h,width:m-l,height:h-k};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();Q+=F[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){M=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(M,10)?Math.max(M,10):f.y1):f.y1<Math.max(M,10)?Math.max(M,10):f.y1;m=Math.round(f.x2-T-X);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-S>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2-S):f.y2>n.height-Math.max(M,10)?n.height-Math.max(M,10):f.y2;if(c&&0<c.length)for(M=0;M<c.length;M++)c[M]&&c[M].labelAutoFit&&(m=0>c[M].labelAngle?Math.max(m,x):0===c[M].labelAngle?Math.max(m,x/2):m,l=0>c[M].labelAngle||0===c[M].labelAngle?m-T:l);if(b&&0<b.length)for(M=0;M<b.length;M++)b[M]&&
...
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();R+=w[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<u){if(a&&0<a.length)for(g=0;g<a.length;g++)r=N[u-1][g]===N[u][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=O[u-1][g]===O[u][g]?!0:
!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=E[u-1][g]===E[u][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=t[u-1][g]===t[u][g]?!0:!1;else L=!0}if(r&&H&&J&&L)break;u++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
this.chart.renderCrosshairs(this.parent);this._hidden=!0};$.prototype.render=function(a,d,c){var b,e,f,l,k=null,m=null,h=null,n="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var p=0,p="xySwapped"===this.chart.plotInfo.axisPlacement?50<this.parent.range?0:500<this.chart.width&&25>this.parent.range?2:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0):50<this.parent.range?
...
this.parent.labelFontSize:this.labelFontSize);this.labelMaxWidth=s(this.options.labelMaxWidth)?0.3*this.chart.width:this.labelMaxWidth;this.labelMaxHeight=s(this.options.labelWrap)||this.labelWrap?0.3*this.chart.height:2*this.labelFontSize;0<p&&q.setLineDash&&q.setLineDash(O(this.lineDashType,p));h=new ia(q,{x:0,y:0,padding:{top:2,right:3,bottom:2,left:4},backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,
...
0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;this.value=x.dataPoint.y[b];h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):s(this.options.label)?ea(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(a-
this.parent.convertValueToPixel(y)),t<u&&(u=t,b=r);k=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;this.value=y;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[w].type){u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));
B=y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,B=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,B=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[B]),t=Math.abs(a-this.parent.convertValueToPixel(B)),t<u&&(u=t,b=r);k=1===q.lineWidth%2?(this.parent.convertValueToPixel(B)<<0)+0.5:this.parent.convertValueToPixel(B)<<0;this.value=B;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:B}):s(this.options.label)?ea(c?
c:B,this.valueFormatString,this.chart._cultureInfo):this.label}else k=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=k;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;
...
this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=u.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?za(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):
this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):s(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;h.y=l+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2+2:h.y+h.measureText().height-h.fontSize/2>this.chart.bounds.y2&&(h.y=
...
value:x.dataPoint.x}):s(this.options.label)?za(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-
...
Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[r])),t<u&&(u=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):s(this.options.label)?ea(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===
this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){u=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<u&&(u=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?
...
1===q.lineWidth%2?(this.parent.convertValueToPixel(B)<<0)+0.5:this.parent.convertValueToPixel(B)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:B}):s(this.options.label)?ea(c?c:B,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=B}else"waterfall"===this.parent.dataSeries[w].type?(m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0)+0.5:this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<
0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum}):s(this.options.label)?ea(c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataSeries.dataPointEOs[x.index].cumulativeSum):(m=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:s(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<
0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataPoint.y);f=l=m;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};h.y=l+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2+2:h.y+h.measureText().height-
...
(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?za(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):
...
this.valueFormatString,this.chart._cultureInfo):this.label,h.x=b-h.measureText().width/2,h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width),h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1),"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("bottom"===this.parent._position||"top"===this.parent._position){B=!1;n="";if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
...
this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?za(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(k);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};na(X,V);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
...
("line"===b.type||"stepLine"===b.type||"spline"===b.type||"scatter"===b.type||"area"===b.type||"stepArea"===b.type||"splineArea"===b.type||"stackedArea"===b.type||"stackedArea100"===b.type||"rangeArea"===b.type||"rangeSplineArea"===b.type?(f=b.getMarkerProperties(l,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=Math.max(1.5*f.size<<0,10),f.borderColor=f.borderColor||"#FFFFFF",f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),W.drawMarkers([f]),"undefined"!==typeof e.y2&&(f=b.getMarkerProperties(l,
e.x1,e.y2,this.chart.overlaidCanvasCtx),f.size=Math.max(1.5*f.size<<0,10),f.borderColor=f.borderColor||"#FFFFFF",f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),W.drawMarkers([f]))):"bubble"===b.type?(f=b.getMarkerProperties(l,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=e.size,f.color="white",f.borderColor="white",d.globalAlpha=0.3,W.drawMarkers([f]),d.globalAlpha=1):"column"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"bar"===b.type||"rangeBar"===b.type||"stackedBar"===
